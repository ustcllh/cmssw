...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Pyquen_DiJet_Pt170_cfi.py,v $'),
    annotation = cms.untracked.string('PYQUEN quenched dijets (pt-hat > 170 GeV) at sqrt(s) = 2.76TeV')
    )
