...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Pyquen_Dijet300_NN_Unquenched_TuneZ2_2760GeV_cfi.py,v $'),
    annotation = cms.untracked.string('PYTHIA (unquenched) dijets in NN (pt-hat > 300 GeV) at sqrt(s) = 2.76TeV')
    )
