...
hiSignal = cms.EDFilter("PyquenGeneratorFilter",
                        ...
                        doRadiativeEnLoss = cms.bool(RAD), ## if true, perform partonic radiative en loss
                        doCollisionalEnLoss = cms.bool(COLL),
                        angularSpectrumSelector = cms.int32(SPEC), ## angular emitted gluon spectrum :
