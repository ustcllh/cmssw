#ifndef RecoAlgos_HiHackedAnalyticalTrackSelector_h
#define RecoAlgos_HiHackedAnalyticalTrackSelector_h
/** \class HiHackedAnalyticalTrackSelector
 *
 ...
 *
 * $Id: HiHackedAnalyticalTrackSelector.h,v 1.2 2010/11/19 20:45:26 sungho Exp $
 *
 */
...
namespace reco { namespace modules {
    ...
    class HiHackedAnalyticalTrackSelector : public edm::EDProducer {
    private:
    public:
      /// constructor
      explicit HiHackedAnalyticalTrackSelector( const edm::ParameterSet & cfg ) ;
      /// destructor
      virtual ~HiHackedAnalyticalTrackSelector() ;
