...
# PF regular
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK1PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK1PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK2PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK2PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK3PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK3PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK4PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK4PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK5PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK5PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK6PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK6PF_generalTracks")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK7PF"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
...
# Calo regular
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK1Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK1Calo_HI")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK2Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK2Calo_HI")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK3Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK3Calo_HI")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK4Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK4Calo_HI")
            ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK5Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK5Calo_HI")
            ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK6Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
                 label = cms.untracked.string("AK6Calo_HI")
            ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_pp_PYTHIAZ2_2760GeV_5320_v29_AK7Calo"),
                 connect = cms.untracked.string("sqlite_file:pp_PYTHIAZ2_2760GeV_5320_v29.db"),
