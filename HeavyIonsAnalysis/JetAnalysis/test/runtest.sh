...
then
  ...
  mkdir samples
  mv pp_DATA_AOD.root pp_DATA_RECO.root pp_MC_AODSIM.root pp_MC_RECODEBUG.root  samples/
  echo Done.
fi
...
replacename=`cat runForestAOD_pp_DATA_92X.py | grep -v '#' | grep -A10 process.source | grep root | sed 's@,@@g' | awk '{print $1}'`
cat runForestAOD_pp_DATA_92X.py | sed 's@'$replacename'@"file:samples/pp_DATA_AOD.root"@g' | sed 's@HiForestAOD.root@HiForestAOD_pp_DATA_AOD.root@g' > test_runForestAOD_pp_DATA_92X.py

#replacename=`cat runForestAOD_PbPb_MIX_75X.py | grep -v '#' | grep -A10 process.source | grep root | sed 's@,@@g' | awk '{print $1}'`
#cat runForestAOD_PbPb_MIX_75X.py | sed 's@'$replacename'@"file:samples/PbPb_MC_AODSIM.root"@g' | sed 's@HiForestAOD.root@HiForestAOD_PbPb_MCMIX_AODSIM.root@g' > test_runForestAOD_PbPb_MIX_75X.py

#replacename=`cat runForestAOD_PbPb_MB_75X.py | grep -v '#' | grep -A10 process.source | grep root | sed 's@,@@g' | awk '{print $1}'`
#cat runForestAOD_PbPb_MB_75X.py | sed 's@'$replacename'@"file:samples/PbPb_MC_AODSIM.root"@g' | sed 's@HiForestAOD.root@HiForestAOD_PbPb_MCMB_AODSIM.root@g' > test_runForestAOD_PbPb_MB_75X.py

replacename=`cat runForestAOD_pp_MC_92X.py | grep -v '#' | grep -A10 process.source | grep root | sed 's@,@@g' | awk '{print $1}'`
cat runForestAOD_pp_MC_92X.py | sed 's@'$replacename'@"file:samples/pp_MC_AODSIM.root"@g' | sed 's@HiForestAOD.root@HiForestAOD_pp_MC_AODSIM.root@g' > test_runForestAOD_pp_MC_92X.py

#replacename=`cat runForestAOD_pPb_MC_80X.py | grep -v '#' | grep -A10 process.source | grep root | sed 's@,@@g' | awk '{print $1}'`
