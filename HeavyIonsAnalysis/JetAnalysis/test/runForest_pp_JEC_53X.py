...
process.source = cms.Source("PoolSource",
    ...
    "/store/himc/HiWinter13/Pythia_AllQCDPhotons_PtHat15_TuneZ2_cmssw53p14_2760GeV/GEN-SIM-RECO/STARTHI53_V28-v1/00000/0A4322D2-1B9A-E311-A881-848F69FD2904.root"
    ))
...
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu7CaloJetSequence_pp_jec_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs7CaloJetSequence_pp_jec_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs7PFJetSequence_pp_jec_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu7PFJetSequence_pp_jec_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak7PFJetSequence_pp_jec_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak7CaloJetSequence_pp_jec_cff')
