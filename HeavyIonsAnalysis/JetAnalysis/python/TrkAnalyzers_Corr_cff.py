...
trackSequencesPbPb = cms.Sequence(tpClusterProducer + quickTrackAssociatorByHits +
                                  tpRecoAssocHiGeneralTracks +
								  anaTrack)
								  
trackSequencesPP = cms.Sequence(tpClusterProducer + quickTrackAssociatorByHits +
