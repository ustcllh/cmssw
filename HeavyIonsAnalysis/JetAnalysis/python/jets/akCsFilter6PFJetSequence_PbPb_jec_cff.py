...
akCsFilter6PFbTagger = bTaggers("akCsFilter6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akCsFilter6PFmatch = akCsFilter6PFbTagger.match
akCsFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsFilter6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
