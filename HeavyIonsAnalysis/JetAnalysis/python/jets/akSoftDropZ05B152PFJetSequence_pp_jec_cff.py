...
#akSoftDropZ05B152PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))
...
akSoftDropZ05B152PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B152PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B152PFJetSequence = cms.Sequence(akSoftDropZ05B152PFJetSequence_jec)
akSoftDropZ05B152PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B152PFJetAnalyzer.jetPtMin = cms.double(1)
