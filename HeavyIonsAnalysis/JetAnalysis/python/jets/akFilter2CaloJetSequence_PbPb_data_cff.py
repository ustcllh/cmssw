...
#akFilter2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))

akFilter2CalobTagger = bTaggers("akFilter2Calo",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akFilter2Calomatch = akFilter2CalobTagger.match
akFilter2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter2CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter2CaloSubjetSecondaryVertexNegativeTagInfos = akFilter2CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter2CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter2CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter2CaloJetSequence = cms.Sequence(akFilter2CaloJetSequence_data)
