...
#akCsSoftDrop6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akCsSoftDrop6PFbTagger = bTaggers("akCsSoftDrop6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop6PFmatch = akCsSoftDrop6PFbTagger.match
akCsSoftDrop6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDrop6PFNegativeCombinedSecondaryVertexV2BJetTags = akCsSoftDrop6PFbTagger.NegativeCombinedSecondaryVertexV2BJetTags
akCsSoftDrop6PFPositiveCombinedSecondaryVertexV2BJetTags = akCsSoftDrop6PFbTagger.PositiveCombinedSecondaryVertexV2BJetTags
...
akCsSoftDrop6PFSubjetImpactParameterTagInfos = akCsSoftDrop6PFbTagger.SubjetImpactParameterTagInfos
akCsSoftDrop6PFSubjetJetProbabilityBJetTags = akCsSoftDrop6PFbTagger.SubjetJetProbabilityBJetTags
akCsSoftDrop6PFSubjetSecondaryVertexTagInfos = akCsSoftDrop6PFbTagger.SubjetSecondaryVertexTagInfos
akCsSoftDrop6PFSubjetSecondaryVertexNegativeTagInfos = akCsSoftDrop6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsSoftDrop6PFSubjetJetTracksAssociatorAtVertex = akCsSoftDrop6PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsSoftDrop6PFCombinedSubjetSecondaryVertexBJetTags = akCsSoftDrop6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsSoftDrop6PFCombinedSubjetSecondaryVertexV2BJetTags = akCsSoftDrop6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsSoftDrop6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsSoftDrop6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsSoftDrop6PFJetBtaggingNegSV = cms.Sequence(akCsSoftDrop6PFImpactParameterTagInfos
            ...
            * (akCsSoftDrop6PFNegativeSimpleSecondaryVertexHighEffBJetTags+
                ...
                akCsSoftDrop6PFNegativeCombinedSecondaryVertexV2BJetTags+
                akCsSoftDrop6PFPositiveCombinedSecondaryVertexV2BJetTags
              )
            )
...
akCsSoftDrop6PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsSoftDrop6PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsSoftDrop6PFPatJetFlavourAssociation"),
...
akCsSoftDrop6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsSoftDrop6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsSoftDrop6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsSoftDrop6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsSoftDrop6PFJets"),
...
akCsSoftDrop6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akCsSoftDrop6PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akCsSoftDrop6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akCsSoftDrop6PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsSoftDrop6PFJetBtagging
                                                  *
                                                  akCsSoftDrop6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsSoftDrop6PFJetSequence = cms.Sequence(akCsSoftDrop6PFJetSequence_jec)
akCsSoftDrop6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDrop6PFJetAnalyzer.jetPtMin = cms.double(1)
