...
akCsFilter5PFmatchGroomed = patJetGenJetMatch.clone(
...
#akCsFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akCsFilter5PFbTagger = bTaggers("akCsFilter5PF",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter5PFmatch = akCsFilter5PFbTagger.match
akCsFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter5PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter5PFSubjetImpactParameterTagInfos = akCsFilter5PFbTagger.SubjetImpactParameterTagInfos
akCsFilter5PFSubjetJetProbabilityBJetTags = akCsFilter5PFbTagger.SubjetJetProbabilityBJetTags
akCsFilter5PFSubjetSecondaryVertexTagInfos = akCsFilter5PFbTagger.SubjetSecondaryVertexTagInfos
akCsFilter5PFSubjetSecondaryVertexNegativeTagInfos = akCsFilter5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsFilter5PFSubjetJetTracksAssociatorAtVertex = akCsFilter5PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsFilter5PFCombinedSubjetSecondaryVertexBJetTags = akCsFilter5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsFilter5PFCombinedSubjetSecondaryVertexV2BJetTags = akCsFilter5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsFilter5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter5PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsFilter5PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsFilter5PFPatJetFlavourAssociation"),
...
akCsFilter5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsFilter5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsFilter5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsFilter5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsFilter5PFJets"),
...
akCsFilter5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCsFilter5PFJetID
                                                  #*
                                                  #akCsFilter5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCsFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCsFilter5PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsFilter5PFJetBtagging
                                                  *
                                                  akCsFilter5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsFilter5PFJetSequence = cms.Sequence(akCsFilter5PFJetSequence_jec)
akCsFilter5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter5PFJetAnalyzer.jetPtMin = cms.double(1)
