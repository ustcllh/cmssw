...
#akVs6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akVs6PFbTagger = bTaggers("akVs6PF",0.6,False,False)

#create objects locally since they dont load properly otherwise
#akVs6PFmatch = akVs6PFbTagger.match
akVs6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVs6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVs6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akVs6PFJetTracksAssociatorAtVertex
                                                  *
                                                  akVs6PFJetBtagging
                                                  *
                                                  akVs6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akVs6PFJetSequence = cms.Sequence(akVs6PFJetSequence_mb)
