...
#akFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akFilter2PFbTagger = bTaggers("akFilter2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akFilter2PFmatch = akFilter2PFbTagger.match
akFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter2PFSubjetSecondaryVertexNegativeTagInfos = akFilter2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter2PFJetSequence = cms.Sequence(akFilter2PFJetSequence_mb)
