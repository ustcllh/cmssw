...
#akFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akFilter6PFbTagger = bTaggers("akFilter6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akFilter6PFmatch = akFilter6PFbTagger.match
akFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter6PFSubjetImpactParameterTagInfos = akFilter6PFbTagger.SubjetImpactParameterTagInfos
akFilter6PFSubjetJetProbabilityBJetTags = akFilter6PFbTagger.SubjetJetProbabilityBJetTags
akFilter6PFSubjetSecondaryVertexTagInfos = akFilter6PFbTagger.SubjetSecondaryVertexTagInfos
akFilter6PFSubjetSecondaryVertexNegativeTagInfos = akFilter6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akFilter6PFSubjetJetTracksAssociatorAtVertex = akFilter6PFbTagger.SubjetJetTracksAssociatorAtVertex
akFilter6PFCombinedSubjetSecondaryVertexBJetTags = akFilter6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akFilter6PFCombinedSubjetSecondaryVertexV2BJetTags = akFilter6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akFilter6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akFilter6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akFilter6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akFilter6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akFilter6PFJets"),
...
akFilter6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter6PFJetSequence = cms.Sequence(akFilter6PFJetSequence_jec)
akFilter6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter6PFJetAnalyzer.jetPtMin = cms.double(1)
