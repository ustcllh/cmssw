...
#akPuSoftDrop2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akPuSoftDrop2CalobTagger = bTaggers("akPuSoftDrop2Calo",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop2Calomatch = akPuSoftDrop2CalobTagger.match
akPuSoftDrop2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop2CaloSubjetImpactParameterTagInfos = akPuSoftDrop2CalobTagger.SubjetImpactParameterTagInfos
akPuSoftDrop2CaloSubjetJetProbabilityBJetTags = akPuSoftDrop2CalobTagger.SubjetJetProbabilityBJetTags
akPuSoftDrop2CaloSubjetSecondaryVertexTagInfos = akPuSoftDrop2CalobTagger.SubjetSecondaryVertexTagInfos
akPuSoftDrop2CaloSubjetSecondaryVertexNegativeTagInfos = akPuSoftDrop2CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuSoftDrop2CaloSubjetJetTracksAssociatorAtVertex = akPuSoftDrop2CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuSoftDrop2CaloCombinedSubjetSecondaryVertexBJetTags = akPuSoftDrop2CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuSoftDrop2CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuSoftDrop2CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuSoftDrop2CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuSoftDrop2CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuSoftDrop2CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuSoftDrop2CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuSoftDrop2CaloPatJetFlavourAssociation"),
...
akPuSoftDrop2CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuSoftDrop2CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuSoftDrop2CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuSoftDrop2CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuSoftDrop2CaloJets"),
...
akPuSoftDrop2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuSoftDrop2CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuSoftDrop2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop2CaloJetSequence = cms.Sequence(akPuSoftDrop2CaloJetSequence_mb)
