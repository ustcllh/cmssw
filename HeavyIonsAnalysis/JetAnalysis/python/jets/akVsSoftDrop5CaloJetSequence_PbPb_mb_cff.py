...
akVsSoftDrop5CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop5CaloJets:sym']
akVsSoftDrop5CalopatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop5CaloJets:droppedBranches']
