...
ak4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
ak4CaloJetSequence = cms.Sequence(ak4CaloJetSequence_mb)
