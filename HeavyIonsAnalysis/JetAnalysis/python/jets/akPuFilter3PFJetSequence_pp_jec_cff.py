...
#akPuFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akPuFilter3PFbTagger = bTaggers("akPuFilter3PF",0.3,True,True)

#create objects locally since they dont load properly otherwise
#akPuFilter3PFmatch = akPuFilter3PFbTagger.match
akPuFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter3PFJets"), matched = cms.InputTag("genParticles"))
...
akPuFilter3PFSubjetImpactParameterTagInfos = akPuFilter3PFbTagger.SubjetImpactParameterTagInfos
akPuFilter3PFSubjetJetProbabilityBJetTags = akPuFilter3PFbTagger.SubjetJetProbabilityBJetTags
akPuFilter3PFSubjetSecondaryVertexTagInfos = akPuFilter3PFbTagger.SubjetSecondaryVertexTagInfos
akPuFilter3PFSubjetSecondaryVertexNegativeTagInfos = akPuFilter3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter3PFSubjetJetTracksAssociatorAtVertex = akPuFilter3PFbTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter3PFCombinedSubjetSecondaryVertexBJetTags = akPuFilter3PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter3PFCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter3PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter3PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter3PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter3PFPatJetFlavourAssociation"),
...
akPuFilter3PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter3PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter3PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter3PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter3PFJets"),
...
akPuFilter3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPuFilter3PFJetID
                                                  #*
                                                  #akPuFilter3PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akPuFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuFilter3PFJetSequence = cms.Sequence(akPuFilter3PFJetSequence_jec)
akPuFilter3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter3PFJetAnalyzer.jetPtMin = cms.double(1)
