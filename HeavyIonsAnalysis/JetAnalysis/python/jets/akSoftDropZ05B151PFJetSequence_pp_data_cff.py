...
#akSoftDropZ05B151PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))
...
akSoftDropZ05B151PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B151PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B151PFJetSequence = cms.Sequence(akSoftDropZ05B151PFJetSequence_data)
