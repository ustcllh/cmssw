...
#akVsSoftDropZ05B152Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))
...
akVsSoftDropZ05B152Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B152CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B152CaloJetSequence = cms.Sequence(akVsSoftDropZ05B152CaloJetSequence_jec)
akVsSoftDropZ05B152CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B152CaloJetAnalyzer.jetPtMin = cms.double(1)
