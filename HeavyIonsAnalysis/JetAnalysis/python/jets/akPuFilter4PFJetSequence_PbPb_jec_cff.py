...
#akPuFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akPuFilter4PFbTagger = bTaggers("akPuFilter4PF",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter4PFmatch = akPuFilter4PFbTagger.match
akPuFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter4PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuFilter4PFSubjetImpactParameterTagInfos = akPuFilter4PFbTagger.SubjetImpactParameterTagInfos
akPuFilter4PFSubjetJetProbabilityBJetTags = akPuFilter4PFbTagger.SubjetJetProbabilityBJetTags
akPuFilter4PFSubjetSecondaryVertexTagInfos = akPuFilter4PFbTagger.SubjetSecondaryVertexTagInfos
akPuFilter4PFSubjetSecondaryVertexNegativeTagInfos = akPuFilter4PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter4PFSubjetJetTracksAssociatorAtVertex = akPuFilter4PFbTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter4PFCombinedSubjetSecondaryVertexBJetTags = akPuFilter4PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter4PFCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter4PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter4PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter4PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter4PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter4PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter4PFPatJetFlavourAssociation"),
...
akPuFilter4PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter4PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter4PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter4PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter4PFJets"),
...
akPuFilter4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPuFilter4PFJetID
                                                  #*
                                                  #akPuFilter4PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter4PFJetSequence = cms.Sequence(akPuFilter4PFJetSequence_jec)
akPuFilter4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter4PFJetAnalyzer.jetPtMin = cms.double(1)
