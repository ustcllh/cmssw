...
#akPuFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akPuFilter1CalobTagger = bTaggers("akPuFilter1Calo",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter1Calomatch = akPuFilter1CalobTagger.match
akPuFilter1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter1CaloSubjetSecondaryVertexNegativeTagInfos = akPuFilter1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akPuFilter1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter1CaloJetSequence = cms.Sequence(akPuFilter1CaloJetSequence_mb)
