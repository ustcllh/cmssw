...
#akPuSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akPuSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B155PFJets"), matched = cms.InputTag("genParticles"))
