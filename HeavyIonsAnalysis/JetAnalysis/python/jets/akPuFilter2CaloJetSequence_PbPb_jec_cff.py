...
#akPuFilter2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))

akPuFilter2CalobTagger = bTaggers("akPuFilter2Calo",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter2Calomatch = akPuFilter2CalobTagger.match
akPuFilter2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter2CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuFilter2CaloSubjetImpactParameterTagInfos = akPuFilter2CalobTagger.SubjetImpactParameterTagInfos
akPuFilter2CaloSubjetJetProbabilityBJetTags = akPuFilter2CalobTagger.SubjetJetProbabilityBJetTags
akPuFilter2CaloSubjetSecondaryVertexTagInfos = akPuFilter2CalobTagger.SubjetSecondaryVertexTagInfos
akPuFilter2CaloSubjetSecondaryVertexNegativeTagInfos = akPuFilter2CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter2CaloSubjetJetTracksAssociatorAtVertex = akPuFilter2CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter2CaloCombinedSubjetSecondaryVertexBJetTags = akPuFilter2CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter2CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter2CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter2CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter2CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter2CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter2CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter2CaloPatJetFlavourAssociation"),
...
akPuFilter2CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter2CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter2CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter2CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter2CaloJets"),
...
akPuFilter2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuFilter2CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuFilter2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter2CaloJetSequence = cms.Sequence(akPuFilter2CaloJetSequence_jec)
akPuFilter2CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter2CaloJetAnalyzer.jetPtMin = cms.double(1)
