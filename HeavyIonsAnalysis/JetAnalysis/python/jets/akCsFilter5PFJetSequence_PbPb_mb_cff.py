...
#akCsFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akCsFilter5PFbTagger = bTaggers("akCsFilter5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akCsFilter5PFmatch = akCsFilter5PFbTagger.match
akCsFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsFilter5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akCsFilter5PFJetSequence = cms.Sequence(akCsFilter5PFJetSequence_mb)
