...
#akSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akSoftDrop6CalobTagger = bTaggers("akSoftDrop6Calo",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop6Calomatch = akSoftDrop6CalobTagger.match
akSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDrop6CaloSubjetSecondaryVertexNegativeTagInfos = akSoftDrop6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akSoftDrop6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akSoftDrop6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop6CaloJetSequence = cms.Sequence(akSoftDrop6CaloJetSequence_jec)
akSoftDrop6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDrop6CaloJetAnalyzer.jetPtMin = cms.double(1)
