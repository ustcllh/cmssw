...
#akVsSoftDropZ05B156PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))
...
akVsSoftDropZ05B156PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B156PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropZ05B156PFJetSequence = cms.Sequence(akVsSoftDropZ05B156PFJetSequence_jec)
akVsSoftDropZ05B156PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B156PFJetAnalyzer.jetPtMin = cms.double(1)
