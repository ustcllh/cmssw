...
#akPuFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akPuFilter5PFbTagger = bTaggers("akPuFilter5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter5PFmatch = akPuFilter5PFbTagger.match
akPuFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter5PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuFilter5PFSubjetImpactParameterTagInfos = akPuFilter5PFbTagger.SubjetImpactParameterTagInfos
akPuFilter5PFSubjetJetProbabilityBJetTags = akPuFilter5PFbTagger.SubjetJetProbabilityBJetTags
akPuFilter5PFSubjetSecondaryVertexTagInfos = akPuFilter5PFbTagger.SubjetSecondaryVertexTagInfos
akPuFilter5PFSubjetSecondaryVertexNegativeTagInfos = akPuFilter5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter5PFSubjetJetTracksAssociatorAtVertex = akPuFilter5PFbTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter5PFCombinedSubjetSecondaryVertexBJetTags = akPuFilter5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter5PFCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter5PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter5PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter5PFPatJetFlavourAssociation"),
...
akPuFilter5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter5PFJets"),
...
akPuFilter5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPuFilter5PFJetID
                                                  #*
                                                  #akPuFilter5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter5PFJetSequence = cms.Sequence(akPuFilter5PFJetSequence_jec)
akPuFilter5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter5PFJetAnalyzer.jetPtMin = cms.double(1)
