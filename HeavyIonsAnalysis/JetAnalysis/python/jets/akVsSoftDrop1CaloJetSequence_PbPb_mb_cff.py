...
#akVsSoftDrop1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akVsSoftDrop1CalobTagger = bTaggers("akVsSoftDrop1Calo",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop1Calomatch = akVsSoftDrop1CalobTagger.match
akVsSoftDrop1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVsSoftDrop1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop1CaloJetSequence = cms.Sequence(akVsSoftDrop1CaloJetSequence_mb)
