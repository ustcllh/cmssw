...
#akFilter1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))

akFilter1PFbTagger = bTaggers("akFilter1PF",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akFilter1PFmatch = akFilter1PFbTagger.match
akFilter1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter1PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter1PFSubjetSecondaryVertexNegativeTagInfos = akFilter1PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter1PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter1PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter1PFJetSequence = cms.Sequence(akFilter1PFJetSequence_jec)
akFilter1PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter1PFJetAnalyzer.jetPtMin = cms.double(1)
