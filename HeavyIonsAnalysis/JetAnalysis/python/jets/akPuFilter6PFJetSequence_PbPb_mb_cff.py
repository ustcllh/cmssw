...
#akPuFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akPuFilter6PFbTagger = bTaggers("akPuFilter6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter6PFmatch = akPuFilter6PFbTagger.match
akPuFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter6PFJetSequence = cms.Sequence(akPuFilter6PFJetSequence_mb)
