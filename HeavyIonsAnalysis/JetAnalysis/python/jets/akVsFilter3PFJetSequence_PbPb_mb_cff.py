...
#akVsFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akVsFilter3PFbTagger = bTaggers("akVsFilter3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter3PFmatch = akVsFilter3PFbTagger.match
akVsFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter3PFJetSequence = cms.Sequence(akVsFilter3PFJetSequence_mb)
