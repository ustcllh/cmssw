...
#akVs3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akVs3PFbTagger = bTaggers("akVs3PF",0.3,False,False)

#create objects locally since they dont load properly otherwise
#akVs3PFmatch = akVs3PFbTagger.match
akVs3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs3PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
#SUBJETDUMMY_akVs3PFSubjetImpactParameterTagInfos = akVs3PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akVs3PFSubjetJetProbabilityBJetTags = akVs3PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akVs3PFSubjetSecondaryVertexTagInfos = akVs3PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akVs3PFSubjetSecondaryVertexNegativeTagInfos = akVs3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akVs3PFSubjetJetTracksAssociatorAtVertex = akVs3PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akVs3PFCombinedSubjetSecondaryVertexBJetTags = akVs3PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akVs3PFCombinedSubjetSecondaryVertexV2BJetTags = akVs3PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akVs3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVs3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVs3PFNjettiness = Njettiness.clone(
		    src = cms.InputTag("akVs3PFJets"),
           	    R0  = cms.double( 0.3)
)
akVs3PFpatJetsWithBtagging.userData.userFloats.src += ['akVs3PFNjettiness:tau1','akVs3PFNjettiness:tau2','akVs3PFNjettiness:tau3']
...
akVs3PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVs3PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVs3PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVs3PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVs3PFJets"),
...
akVs3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVs3PFJetID
                                                  #*
                                                  #akVs3PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVs3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akVs3PFJetTracksAssociatorAtVertex
                                                  *
                                                  akVs3PFJetBtagging
                                                  *
                                                  akVs3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akVs3PFJetSequence_mb = cms.Sequence(akVs3PFJetSequence_mc)

akVs3PFJetSequence = cms.Sequence(akVs3PFJetSequence_jec)
akVs3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVs3PFJetAnalyzer.jetPtMin = cms.double(1)
