...
#akVsSoftDropZ05B153Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))
...
akVsSoftDropZ05B153Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B153CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropZ05B153CaloJetSequence = cms.Sequence(akVsSoftDropZ05B153CaloJetSequence_jec)
akVsSoftDropZ05B153CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B153CaloJetAnalyzer.jetPtMin = cms.double(1)
