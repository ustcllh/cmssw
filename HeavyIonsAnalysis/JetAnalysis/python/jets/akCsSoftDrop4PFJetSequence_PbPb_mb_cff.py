...
#akCsSoftDrop4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akCsSoftDrop4PFJetSequence = cms.Sequence(akCsSoftDrop4PFJetSequence_mb)
