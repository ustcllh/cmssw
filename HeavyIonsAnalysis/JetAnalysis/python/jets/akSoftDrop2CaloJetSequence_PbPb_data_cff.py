...
#akSoftDrop2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))

akSoftDrop2CalobTagger = bTaggers("akSoftDrop2Calo",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop2Calomatch = akSoftDrop2CalobTagger.match
akSoftDrop2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop2CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDrop2CaloSubjetSecondaryVertexNegativeTagInfos = akSoftDrop2CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akSoftDrop2CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop2CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akSoftDrop2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop2CaloJetSequence = cms.Sequence(akSoftDrop2CaloJetSequence_data)
