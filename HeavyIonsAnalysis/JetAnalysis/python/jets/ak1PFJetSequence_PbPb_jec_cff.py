...
#ak1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))

ak1PFbTagger = bTaggers("ak1PF",0.1,False,False)

#create objects locally since they dont load properly otherwise
#ak1PFmatch = ak1PFbTagger.match
ak1PFparton = patJetPartonMatch.clone(src = cms.InputTag("ak1PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
#SUBJETDUMMY_ak1PFSubjetSecondaryVertexNegativeTagInfos = ak1PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak1PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak1PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
