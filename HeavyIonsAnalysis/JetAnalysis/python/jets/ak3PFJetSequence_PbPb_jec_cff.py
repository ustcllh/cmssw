...
#ak3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

ak3PFbTagger = bTaggers("ak3PF",0.3,False,False)

#create objects locally since they dont load properly otherwise
#ak3PFmatch = ak3PFbTagger.match
ak3PFparton = patJetPartonMatch.clone(src = cms.InputTag("ak3PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
#SUBJETDUMMY_ak3PFSubjetSecondaryVertexNegativeTagInfos = ak3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  ak3PFJetTracksAssociatorAtVertex
                                                  *
                                                  ak3PFJetBtagging
                                                  *
                                                  ak3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
