...
#akPuSoftDrop1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))
...
akPuSoftDrop1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop1CaloJetSequence = cms.Sequence(akPuSoftDrop1CaloJetSequence_mb)
