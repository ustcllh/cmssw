...
#akSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B155PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B155PFJetSequence = cms.Sequence(akSoftDropZ05B155PFJetSequence_data)
