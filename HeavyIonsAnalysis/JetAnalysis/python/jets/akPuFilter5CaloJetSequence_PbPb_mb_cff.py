...
#akPuFilter5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akPuFilter5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter5CaloJetSequence = cms.Sequence(akPuFilter5CaloJetSequence_mb)
