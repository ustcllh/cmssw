...
#akFilter2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akFilter2CalobTagger = bTaggers("akFilter2Calo",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akFilter2Calomatch = akFilter2CalobTagger.match
akFilter2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter2CaloJetSequence = cms.Sequence(akFilter2CaloJetSequence_mb)
