        ...
        do
            ...
            do
			    ...
			    # no Cs Calo or pp jets
                           ...
                           # if ( [ $system == "pPb" ] ) && ( ( [ $radius -ne 4 ] && [ $radius -ne 3 ] ) || [ $groom != "NONE" ] ) ; then 
                            #    continue
                            #fi
			    ...
			    #genjets="HiGenJets"
                            genjets="HiSignalGenJets" #MV: not sure what to use for pPb
                            if [ $sample == "mb" ]; then
                                 genjets="HiGenJets"
                            fi
                            ismc="False"
			    ...
			    if [ $groom == "SoftDrop" ] || [ $groom == "SoftDropZ05B15" ] || [ $groom == "Filter" ]; then
			        doSubJets="True"
                                if ( [ $sample == "mc" ] || [ $sample == "jec" ] ) && ( [ $groom == "SoftDrop" ] || [ $groom == "SoftDropZ05B15" ] ); then
                                    doGenSubJets="True"
                                    doGenSym="True"
                                fi
			    fi
