...
#akVsSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akVsSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B155PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B155PFJetSequence = cms.Sequence(akVsSoftDropZ05B155PFJetSequence_jec)
akVsSoftDropZ05B155PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B155PFJetAnalyzer.jetPtMin = cms.double(1)
