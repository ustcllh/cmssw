...
#akPuSoftDrop3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPuSoftDrop3PFbTagger = bTaggers("akPuSoftDrop3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop3PFmatch = akPuSoftDrop3PFbTagger.match
akPuSoftDrop3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuSoftDrop3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop3PFJetSequence = cms.Sequence(akPuSoftDrop3PFJetSequence_mb)
