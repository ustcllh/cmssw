...
#akFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akFilter1CalobTagger = bTaggers("akFilter1Calo",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akFilter1Calomatch = akFilter1CalobTagger.match
akFilter1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter1CaloSubjetSecondaryVertexNegativeTagInfos = akFilter1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter1CaloJetSequence = cms.Sequence(akFilter1CaloJetSequence_mb)
