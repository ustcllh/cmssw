...
akCs1PFmatchGroomed = patJetGenJetMatch.clone(
...
#akCs1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))

akCs1PFbTagger = bTaggers("akCs1PF",0.1,False,False)

#create objects locally since they dont load properly otherwise
#akCs1PFmatch = akCs1PFbTagger.match
akCs1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs1PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
#SUBJETDUMMY_akCs1PFSubjetImpactParameterTagInfos = akCs1PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akCs1PFSubjetJetProbabilityBJetTags = akCs1PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akCs1PFSubjetSecondaryVertexTagInfos = akCs1PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akCs1PFSubjetSecondaryVertexNegativeTagInfos = akCs1PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akCs1PFSubjetJetTracksAssociatorAtVertex = akCs1PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akCs1PFCombinedSubjetSecondaryVertexBJetTags = akCs1PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akCs1PFCombinedSubjetSecondaryVertexV2BJetTags = akCs1PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akCs1PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCs1PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCs1PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCs1PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCs1PFPatJetFlavourAssociation"),
...
akCs1PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCs1PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCs1PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCs1PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCs1PFJets"),
...
akCs1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCs1PFJetID
                                                  #*
                                                  #akCs1PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akCs1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akCs1PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCs1PFJetBtagging
                                                  *
                                                  akCs1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCs1PFJetSequence = cms.Sequence(akCs1PFJetSequence_data)
