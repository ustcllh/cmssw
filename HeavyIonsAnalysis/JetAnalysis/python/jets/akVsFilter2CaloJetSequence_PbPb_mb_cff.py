...
#akVsFilter2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akVsFilter2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter2CaloJetSequence = cms.Sequence(akVsFilter2CaloJetSequence_mb)
