...
#ak2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

ak2PFbTagger = bTaggers("ak2PF",0.2,False,False)

#create objects locally since they dont load properly otherwise
#ak2PFmatch = ak2PFbTagger.match
ak2PFparton = patJetPartonMatch.clone(src = cms.InputTag("ak2PFJets"), matched = cms.InputTag("selectedPartons"))
...
ak2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
ak2PFJetSequence = cms.Sequence(ak2PFJetSequence_mb)
