...
#akFilter1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akFilter1PFbTagger = bTaggers("akFilter1PF",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akFilter1PFmatch = akFilter1PFbTagger.match
akFilter1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter1PFJetSequence = cms.Sequence(akFilter1PFJetSequence_mb)
