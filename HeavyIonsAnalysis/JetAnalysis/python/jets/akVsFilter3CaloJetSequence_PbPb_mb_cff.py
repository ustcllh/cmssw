...
#akVsFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akVsFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter3CaloJetSequence = cms.Sequence(akVsFilter3CaloJetSequence_mb)
