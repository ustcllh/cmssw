...
#akCsSoftDrop3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akCsSoftDrop3PFJetSequence = cms.Sequence(akCsSoftDrop3PFJetSequence_mb)
