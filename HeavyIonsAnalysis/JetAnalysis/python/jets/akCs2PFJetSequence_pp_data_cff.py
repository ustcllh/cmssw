...
#akCs2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akCs2PFbTagger = bTaggers("akCs2PF",0.2,True,False)

#create objects locally since they dont load properly otherwise
#akCs2PFmatch = akCs2PFbTagger.match
akCs2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs2PFJets"), matched = cms.InputTag("genParticles"))
...
#SUBJETDUMMY_akCs2PFSubjetImpactParameterTagInfos = akCs2PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akCs2PFSubjetJetProbabilityBJetTags = akCs2PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akCs2PFSubjetSecondaryVertexTagInfos = akCs2PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akCs2PFSubjetSecondaryVertexNegativeTagInfos = akCs2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akCs2PFSubjetJetTracksAssociatorAtVertex = akCs2PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akCs2PFCombinedSubjetSecondaryVertexBJetTags = akCs2PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akCs2PFCombinedSubjetSecondaryVertexV2BJetTags = akCs2PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akCs2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCs2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCs2PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCs2PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCs2PFPatJetFlavourAssociation"),
...
akCs2PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCs2PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCs2PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCs2PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCs2PFJets"),
...
akCs2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCs2PFJetID
                                                  #*
                                                  #akCs2PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCs2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCs2PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCs2PFJetBtagging
                                                  *
                                                  akCs2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCs2PFJetSequence = cms.Sequence(akCs2PFJetSequence_data)
