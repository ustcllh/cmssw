...
#akCsFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akCsFilter3PFbTagger = bTaggers("akCsFilter3PF",0.3,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter3PFmatch = akCsFilter3PFbTagger.match
akCsFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter3PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akCsFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akCsFilter3PFJetSequence = cms.Sequence(akCsFilter3PFJetSequence_data)
