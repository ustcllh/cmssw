...
#akVsFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))
...
akVsFilter1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter1CaloJetSequence = cms.Sequence(akVsFilter1CaloJetSequence_mb)
