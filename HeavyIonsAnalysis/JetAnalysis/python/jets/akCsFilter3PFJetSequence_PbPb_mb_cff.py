...
#akCsFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akCsFilter3PFbTagger = bTaggers("akCsFilter3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akCsFilter3PFmatch = akCsFilter3PFbTagger.match
akCsFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsFilter3PFSubjetImpactParameterTagInfos = akCsFilter3PFbTagger.SubjetImpactParameterTagInfos
akCsFilter3PFSubjetJetProbabilityBJetTags = akCsFilter3PFbTagger.SubjetJetProbabilityBJetTags
akCsFilter3PFSubjetSecondaryVertexTagInfos = akCsFilter3PFbTagger.SubjetSecondaryVertexTagInfos
akCsFilter3PFSubjetSecondaryVertexNegativeTagInfos = akCsFilter3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsFilter3PFSubjetJetTracksAssociatorAtVertex = akCsFilter3PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsFilter3PFCombinedSubjetSecondaryVertexBJetTags = akCsFilter3PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsFilter3PFCombinedSubjetSecondaryVertexV2BJetTags = akCsFilter3PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsFilter3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter3PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsFilter3PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsFilter3PFPatJetFlavourAssociation"),
...
akCsFilter3PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsFilter3PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsFilter3PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsFilter3PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsFilter3PFJets"),
...
akCsFilter3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCsFilter3PFJetID
                                                  #*
                                                  #akCsFilter3PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akCsFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akCsFilter3PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsFilter3PFJetBtagging
                                                  *
                                                  akCsFilter3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsFilter3PFJetSequence = cms.Sequence(akCsFilter3PFJetSequence_mb)
