...
#ak6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

ak6PFbTagger = bTaggers("ak6PF",0.6,False,False)

#create objects locally since they dont load properly otherwise
#ak6PFmatch = ak6PFbTagger.match
ak6PFparton = patJetPartonMatch.clone(src = cms.InputTag("ak6PFJets"), matched = cms.InputTag("selectedPartons"))
...
#SUBJETDUMMY_ak6PFSubjetSecondaryVertexNegativeTagInfos = ak6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
ak6PFJetSequence = cms.Sequence(ak6PFJetSequence_mb)
