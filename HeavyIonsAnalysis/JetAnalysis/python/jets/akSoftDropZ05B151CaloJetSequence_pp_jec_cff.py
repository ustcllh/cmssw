...
#akSoftDropZ05B151Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))
...
akSoftDropZ05B151Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B151CaloJets"), matched = cms.InputTag("genParticles"))
