...
#akCsSoftDropZ05B151PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akCsSoftDropZ05B151PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropZ05B151PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDropZ05B151PFJetSequence = cms.Sequence(akCsSoftDropZ05B151PFJetSequence_jec)
akCsSoftDropZ05B151PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropZ05B151PFJetAnalyzer.jetPtMin = cms.double(1)
