...
akPuSoftDropZ05B156CalomatchGroomed = patJetGenJetMatch.clone(
    src = cms.InputTag("akSoftDropZ05B156HiGenJets"),
    matched = cms.InputTag("ak6HiCleanedGenJets"),
    resolveByMatchQuality = cms.bool(False),
    maxDeltaR = 0.6
    )
...
#akPuSoftDropZ05B156Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akPuSoftDropZ05B156Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B156CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropZ05B156CaloJetSequence = cms.Sequence(akPuSoftDropZ05B156CaloJetSequence_mb)
