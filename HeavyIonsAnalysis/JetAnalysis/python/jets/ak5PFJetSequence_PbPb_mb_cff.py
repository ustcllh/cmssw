...
#ak5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

ak5PFbTagger = bTaggers("ak5PF",0.5,False,False)
...
#SUBJETDUMMY_ak5PFSubjetSecondaryVertexNegativeTagInfos = ak5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
ak5PFJetSequence = cms.Sequence(ak5PFJetSequence_mb)
