...
#akPuFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akPuFilter4PFbTagger = bTaggers("akPuFilter4PF",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter4PFmatch = akPuFilter4PFbTagger.match
akPuFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter4PFJetSequence = cms.Sequence(akPuFilter4PFJetSequence_mb)
