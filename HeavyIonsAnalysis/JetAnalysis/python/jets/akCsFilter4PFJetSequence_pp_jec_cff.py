...
#akCsFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))

akCsFilter4PFbTagger = bTaggers("akCsFilter4PF",0.4,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter4PFmatch = akCsFilter4PFbTagger.match
akCsFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter4PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter4PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter4PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter4PFJetSequence = cms.Sequence(akCsFilter4PFJetSequence_jec)
akCsFilter4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter4PFJetAnalyzer.jetPtMin = cms.double(1)
