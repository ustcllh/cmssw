...
#akFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akFilter6CalobTagger = bTaggers("akFilter6Calo",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akFilter6Calomatch = akFilter6CalobTagger.match
akFilter6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter6CaloSubjetSecondaryVertexNegativeTagInfos = akFilter6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter6CaloJetSequence = cms.Sequence(akFilter6CaloJetSequence_mb)
