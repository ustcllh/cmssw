...
#akSoftDrop2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))

akSoftDrop2PFbTagger = bTaggers("akSoftDrop2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop2PFmatch = akSoftDrop2PFbTagger.match
akSoftDrop2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop2PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDrop2PFSubjetImpactParameterTagInfos = akSoftDrop2PFbTagger.SubjetImpactParameterTagInfos
akSoftDrop2PFSubjetJetProbabilityBJetTags = akSoftDrop2PFbTagger.SubjetJetProbabilityBJetTags
akSoftDrop2PFSubjetSecondaryVertexTagInfos = akSoftDrop2PFbTagger.SubjetSecondaryVertexTagInfos
akSoftDrop2PFSubjetSecondaryVertexNegativeTagInfos = akSoftDrop2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akSoftDrop2PFSubjetJetTracksAssociatorAtVertex = akSoftDrop2PFbTagger.SubjetJetTracksAssociatorAtVertex
akSoftDrop2PFCombinedSubjetSecondaryVertexBJetTags = akSoftDrop2PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akSoftDrop2PFCombinedSubjetSecondaryVertexV2BJetTags = akSoftDrop2PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akSoftDrop2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop2PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akSoftDrop2PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akSoftDrop2PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akSoftDrop2PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akSoftDrop2PFJets"),
...
akSoftDrop2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akSoftDrop2PFJetID
                                                  #*
                                                  #akSoftDrop2PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akSoftDrop2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop2PFJetSequence = cms.Sequence(akSoftDrop2PFJetSequence_jec)
akSoftDrop2PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDrop2PFJetAnalyzer.jetPtMin = cms.double(1)
