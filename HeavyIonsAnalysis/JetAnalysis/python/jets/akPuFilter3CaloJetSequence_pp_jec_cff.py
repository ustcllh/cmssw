...
#akPuFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akPuFilter3CalobTagger = bTaggers("akPuFilter3Calo",0.3,True,True)

#create objects locally since they dont load properly otherwise
#akPuFilter3Calomatch = akPuFilter3CalobTagger.match
akPuFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter3CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuFilter3CaloSubjetImpactParameterTagInfos = akPuFilter3CalobTagger.SubjetImpactParameterTagInfos
akPuFilter3CaloSubjetJetProbabilityBJetTags = akPuFilter3CalobTagger.SubjetJetProbabilityBJetTags
akPuFilter3CaloSubjetSecondaryVertexTagInfos = akPuFilter3CalobTagger.SubjetSecondaryVertexTagInfos
akPuFilter3CaloSubjetSecondaryVertexNegativeTagInfos = akPuFilter3CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter3CaloSubjetJetTracksAssociatorAtVertex = akPuFilter3CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter3CaloCombinedSubjetSecondaryVertexBJetTags = akPuFilter3CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter3CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter3CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter3CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter3CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter3CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter3CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter3CaloPatJetFlavourAssociation"),
...
akPuFilter3CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter3CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter3CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter3CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter3CaloJets"),
...
akPuFilter3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuFilter3CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akPuFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuFilter3CaloJetSequence = cms.Sequence(akPuFilter3CaloJetSequence_jec)
akPuFilter3CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter3CaloJetAnalyzer.jetPtMin = cms.double(1)
