...
#akVsFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akVsFilter2PFbTagger = bTaggers("akVsFilter2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter2PFmatch = akVsFilter2PFbTagger.match
akVsFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter2PFJetSequence = cms.Sequence(akVsFilter2PFJetSequence_mb)
