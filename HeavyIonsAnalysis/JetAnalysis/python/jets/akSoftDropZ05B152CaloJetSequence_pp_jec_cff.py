...
#akSoftDropZ05B152Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))
...
akSoftDropZ05B152Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B152CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B152CaloJetSequence = cms.Sequence(akSoftDropZ05B152CaloJetSequence_jec)
akSoftDropZ05B152CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B152CaloJetAnalyzer.jetPtMin = cms.double(1)
