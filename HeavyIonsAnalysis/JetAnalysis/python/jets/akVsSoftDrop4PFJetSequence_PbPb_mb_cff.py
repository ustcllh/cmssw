...
#akVsSoftDrop4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akVsSoftDrop4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop4PFJetSequence = cms.Sequence(akVsSoftDrop4PFJetSequence_mb)
