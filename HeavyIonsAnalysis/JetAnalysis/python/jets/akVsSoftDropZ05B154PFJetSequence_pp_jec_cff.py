...
#akVsSoftDropZ05B154PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))
...
akVsSoftDropZ05B154PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B154PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B154PFJetSequence = cms.Sequence(akVsSoftDropZ05B154PFJetSequence_jec)
akVsSoftDropZ05B154PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B154PFJetAnalyzer.jetPtMin = cms.double(1)
