...
#akVsSoftDropZ05B151PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))
...
akVsSoftDropZ05B151PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B151PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B151PFJetSequence = cms.Sequence(akVsSoftDropZ05B151PFJetSequence_jec)
akVsSoftDropZ05B151PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B151PFJetAnalyzer.jetPtMin = cms.double(1)
