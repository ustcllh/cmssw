...
#akCsSoftDrop6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akCsSoftDrop6PFbTagger = bTaggers("akCsSoftDrop6PF",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop6PFmatch = akCsSoftDrop6PFbTagger.match
akCsSoftDrop6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop6PFJets"), matched = cms.InputTag("genParticles"))
...
akCsSoftDrop6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akCsSoftDrop6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
