...
#akSoftDropZ05B153PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))
...
akSoftDropZ05B153PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B153PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDropZ05B153PFJetSequence = cms.Sequence(akSoftDropZ05B153PFJetSequence_jec)
akSoftDropZ05B153PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B153PFJetAnalyzer.jetPtMin = cms.double(1)
