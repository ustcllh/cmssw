...
akSoftDrop5CalopatJetsWithBtagging.userData.userFloats.src += ['akSoftDrop5CaloJets:sym']
akSoftDrop5CalopatJetsWithBtagging.userData.userInts.src += ['akSoftDrop5CaloJets:droppedBranches']
