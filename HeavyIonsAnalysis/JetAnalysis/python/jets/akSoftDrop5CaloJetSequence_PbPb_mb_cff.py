...
#akSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akSoftDrop5CalobTagger = bTaggers("akSoftDrop5Calo",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop5Calomatch = akSoftDrop5CalobTagger.match
akSoftDrop5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop5CaloSubjetSecondaryVertexNegativeTagInfos = akSoftDrop5CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akSoftDrop5CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop5CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akSoftDrop5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop5CaloJetSequence = cms.Sequence(akSoftDrop5CaloJetSequence_mb)
