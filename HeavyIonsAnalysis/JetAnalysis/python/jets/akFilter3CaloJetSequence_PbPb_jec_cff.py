...
#akFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akFilter3CalobTagger = bTaggers("akFilter3Calo",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akFilter3Calomatch = akFilter3CalobTagger.match
akFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter3CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter3CaloSubjetSecondaryVertexNegativeTagInfos = akFilter3CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter3CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter3CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter3CaloJetSequence = cms.Sequence(akFilter3CaloJetSequence_jec)
akFilter3CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter3CaloJetAnalyzer.jetPtMin = cms.double(1)
