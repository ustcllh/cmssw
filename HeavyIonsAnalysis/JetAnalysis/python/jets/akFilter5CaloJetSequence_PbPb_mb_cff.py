...
#akFilter5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akFilter5CalobTagger = bTaggers("akFilter5Calo",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akFilter5Calomatch = akFilter5CalobTagger.match
akFilter5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter5CaloJetSequence = cms.Sequence(akFilter5CaloJetSequence_mb)
