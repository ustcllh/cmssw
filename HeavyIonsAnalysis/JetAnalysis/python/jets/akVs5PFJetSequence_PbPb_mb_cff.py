...
akVs5PFmatchGroomed = patJetGenJetMatch.clone(
...
#akVs5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akVs5PFbTagger = bTaggers("akVs5PF",0.5,False,False)

#create objects locally since they dont load properly otherwise
#akVs5PFmatch = akVs5PFbTagger.match
akVs5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVs5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVs5PFNegativeCombinedSecondaryVertexV2BJetTags = akVs5PFbTagger.NegativeCombinedSecondaryVertexV2BJetTags
akVs5PFPositiveCombinedSecondaryVertexV2BJetTags = akVs5PFbTagger.PositiveCombinedSecondaryVertexV2BJetTags
...
#SUBJETDUMMY_akVs5PFSubjetImpactParameterTagInfos = akVs5PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akVs5PFSubjetJetProbabilityBJetTags = akVs5PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akVs5PFSubjetSecondaryVertexTagInfos = akVs5PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akVs5PFSubjetSecondaryVertexNegativeTagInfos = akVs5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akVs5PFSubjetJetTracksAssociatorAtVertex = akVs5PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akVs5PFCombinedSubjetSecondaryVertexBJetTags = akVs5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akVs5PFCombinedSubjetSecondaryVertexV2BJetTags = akVs5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akVs5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVs5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVs5PFJetBtaggingNegSV = cms.Sequence(akVs5PFImpactParameterTagInfos
            ...
            * (akVs5PFNegativeSimpleSecondaryVertexHighEffBJetTags+
                ...
                akVs5PFNegativeCombinedSecondaryVertexV2BJetTags+
                akVs5PFPositiveCombinedSecondaryVertexV2BJetTags
              )
            )
...
akVs5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVs5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVs5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVs5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVs5PFJets"),
...
akVs5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVs5PFJetID
                                                  #*
                                                  #akVs5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVs5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akVs5PFJetTracksAssociatorAtVertex
                                                  *
                                                  akVs5PFJetBtagging
                                                  *
                                                  akVs5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akVs5PFJetSequence_mb = cms.Sequence(akVs5PFJetSequence_mc)

akVs5PFJetSequence = cms.Sequence(akVs5PFJetSequence_mb)
