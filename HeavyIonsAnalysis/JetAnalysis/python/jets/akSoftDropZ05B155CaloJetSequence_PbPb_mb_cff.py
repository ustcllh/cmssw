...
#akSoftDropZ05B155Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akSoftDropZ05B155Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B155CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropZ05B155CaloJetSequence = cms.Sequence(akSoftDropZ05B155CaloJetSequence_mb)
