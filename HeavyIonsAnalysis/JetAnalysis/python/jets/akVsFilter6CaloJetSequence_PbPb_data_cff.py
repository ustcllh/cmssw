...
#akVsFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akVsFilter6CalobTagger = bTaggers("akVsFilter6Calo",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter6Calomatch = akVsFilter6CalobTagger.match
akVsFilter6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter6CaloSubjetImpactParameterTagInfos = akVsFilter6CalobTagger.SubjetImpactParameterTagInfos
akVsFilter6CaloSubjetJetProbabilityBJetTags = akVsFilter6CalobTagger.SubjetJetProbabilityBJetTags
akVsFilter6CaloSubjetSecondaryVertexTagInfos = akVsFilter6CalobTagger.SubjetSecondaryVertexTagInfos
akVsFilter6CaloSubjetSecondaryVertexNegativeTagInfos = akVsFilter6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter6CaloSubjetJetTracksAssociatorAtVertex = akVsFilter6CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter6CaloCombinedSubjetSecondaryVertexBJetTags = akVsFilter6CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter6CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter6CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter6CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter6CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter6CaloPatJetFlavourAssociation"),
...
akVsFilter6CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter6CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter6CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter6CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter6CaloJets"),
...
akVsFilter6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsFilter6CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter6CaloJetSequence = cms.Sequence(akVsFilter6CaloJetSequence_data)
