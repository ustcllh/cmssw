...
#akVsSoftDropZ05B156Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))
...
akVsSoftDropZ05B156Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B156CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B156CaloJetSequence = cms.Sequence(akVsSoftDropZ05B156CaloJetSequence_jec)
akVsSoftDropZ05B156CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B156CaloJetAnalyzer.jetPtMin = cms.double(1)
