...
#akFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akFilter5PFbTagger = bTaggers("akFilter5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akFilter5PFmatch = akFilter5PFbTagger.match
akFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter5PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter5PFSubjetSecondaryVertexNegativeTagInfos = akFilter5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter5PFJetSequence = cms.Sequence(akFilter5PFJetSequence_jec)
akFilter5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter5PFJetAnalyzer.jetPtMin = cms.double(1)
