...
akCsSoftDrop1PFbTagger = bTaggers("akCsSoftDrop1PF",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop1PFmatch = akCsSoftDrop1PFbTagger.match
akCsSoftDrop1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop1PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDrop1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsSoftDrop1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
