...
#akCsFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akCsFilter6PFbTagger = bTaggers("akCsFilter6PF",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter6PFmatch = akCsFilter6PFbTagger.match
akCsFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter6PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter6PFSubjetImpactParameterTagInfos = akCsFilter6PFbTagger.SubjetImpactParameterTagInfos
akCsFilter6PFSubjetJetProbabilityBJetTags = akCsFilter6PFbTagger.SubjetJetProbabilityBJetTags
akCsFilter6PFSubjetSecondaryVertexTagInfos = akCsFilter6PFbTagger.SubjetSecondaryVertexTagInfos
akCsFilter6PFSubjetSecondaryVertexNegativeTagInfos = akCsFilter6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsFilter6PFSubjetJetTracksAssociatorAtVertex = akCsFilter6PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsFilter6PFCombinedSubjetSecondaryVertexBJetTags = akCsFilter6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsFilter6PFCombinedSubjetSecondaryVertexV2BJetTags = akCsFilter6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsFilter6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter6PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsFilter6PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsFilter6PFPatJetFlavourAssociation"),
...
akCsFilter6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsFilter6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsFilter6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsFilter6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsFilter6PFJets"),
...
akCsFilter6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCsFilter6PFJetID
                                                  #*
                                                  #akCsFilter6PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCsFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCsFilter6PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsFilter6PFJetBtagging
                                                  *
                                                  akCsFilter6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsFilter6PFJetSequence = cms.Sequence(akCsFilter6PFJetSequence_jec)
akCsFilter6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter6PFJetAnalyzer.jetPtMin = cms.double(1)
