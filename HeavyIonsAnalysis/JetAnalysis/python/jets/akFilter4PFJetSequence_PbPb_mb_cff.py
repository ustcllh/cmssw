...
#akFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akFilter4PFbTagger = bTaggers("akFilter4PF",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akFilter4PFmatch = akFilter4PFbTagger.match
akFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter4PFSubjetSecondaryVertexNegativeTagInfos = akFilter4PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter4PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter4PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter4PFJetSequence = cms.Sequence(akFilter4PFJetSequence_mb)
