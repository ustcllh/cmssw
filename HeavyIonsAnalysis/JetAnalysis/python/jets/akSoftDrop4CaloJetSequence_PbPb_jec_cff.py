...
#akSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akSoftDrop4CalobTagger = bTaggers("akSoftDrop4Calo",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop4Calomatch = akSoftDrop4CalobTagger.match
akSoftDrop4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDrop4CaloSubjetSecondaryVertexNegativeTagInfos = akSoftDrop4CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akSoftDrop4CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop4CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop4CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akSoftDrop4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop4CaloJetSequence = cms.Sequence(akSoftDrop4CaloJetSequence_jec)
akSoftDrop4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDrop4CaloJetAnalyzer.jetPtMin = cms.double(1)
