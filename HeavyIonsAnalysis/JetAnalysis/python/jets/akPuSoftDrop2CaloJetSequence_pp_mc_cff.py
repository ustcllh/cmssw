...
#akPuSoftDrop2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akPuSoftDrop2CalobTagger = bTaggers("akPuSoftDrop2Calo",0.2,True,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop2Calomatch = akPuSoftDrop2CalobTagger.match
akPuSoftDrop2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop2CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDrop2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akPuSoftDrop2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuSoftDrop2CaloJetSequence = cms.Sequence(akPuSoftDrop2CaloJetSequence_mc)
