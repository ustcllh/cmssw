...
#akVsSoftDrop2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akVsSoftDrop2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop2CaloJetSequence = cms.Sequence(akVsSoftDrop2CaloJetSequence_mb)
