...
#akPuFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPuFilter3PFbTagger = bTaggers("akPuFilter3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter3PFmatch = akPuFilter3PFbTagger.match
akPuFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter3PFJetSequence = cms.Sequence(akPuFilter3PFJetSequence_mb)
