...
#akVsFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))

akVsFilter4PFbTagger = bTaggers("akVsFilter4PF",0.4,True,True)

#create objects locally since they dont load properly otherwise
#akVsFilter4PFmatch = akVsFilter4PFbTagger.match
akVsFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter4PFJets"), matched = cms.InputTag("genParticles"))
...
akVsFilter4PFSubjetImpactParameterTagInfos = akVsFilter4PFbTagger.SubjetImpactParameterTagInfos
akVsFilter4PFSubjetJetProbabilityBJetTags = akVsFilter4PFbTagger.SubjetJetProbabilityBJetTags
akVsFilter4PFSubjetSecondaryVertexTagInfos = akVsFilter4PFbTagger.SubjetSecondaryVertexTagInfos
akVsFilter4PFSubjetSecondaryVertexNegativeTagInfos = akVsFilter4PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter4PFSubjetJetTracksAssociatorAtVertex = akVsFilter4PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter4PFCombinedSubjetSecondaryVertexBJetTags = akVsFilter4PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter4PFCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter4PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter4PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter4PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter4PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter4PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter4PFPatJetFlavourAssociation"),
...
akVsFilter4PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter4PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter4PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter4PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter4PFJets"),
...
akVsFilter4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVsFilter4PFJetID
                                                  #*
                                                  #akVsFilter4PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akVsFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsFilter4PFJetSequence = cms.Sequence(akVsFilter4PFJetSequence_jec)
akVsFilter4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter4PFJetAnalyzer.jetPtMin = cms.double(1)
