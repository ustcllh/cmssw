...
#akCsSoftDrop5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akCsSoftDrop5PFbTagger = bTaggers("akCsSoftDrop5PF",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop5PFmatch = akCsSoftDrop5PFbTagger.match
akCsSoftDrop5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop5PFJets"), matched = cms.InputTag("genParticles"))
...
akCsSoftDrop5PFSubjetImpactParameterTagInfos = akCsSoftDrop5PFbTagger.SubjetImpactParameterTagInfos
akCsSoftDrop5PFSubjetJetProbabilityBJetTags = akCsSoftDrop5PFbTagger.SubjetJetProbabilityBJetTags
akCsSoftDrop5PFSubjetSecondaryVertexTagInfos = akCsSoftDrop5PFbTagger.SubjetSecondaryVertexTagInfos
akCsSoftDrop5PFSubjetSecondaryVertexNegativeTagInfos = akCsSoftDrop5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsSoftDrop5PFSubjetJetTracksAssociatorAtVertex = akCsSoftDrop5PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsSoftDrop5PFCombinedSubjetSecondaryVertexBJetTags = akCsSoftDrop5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsSoftDrop5PFCombinedSubjetSecondaryVertexV2BJetTags = akCsSoftDrop5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsSoftDrop5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsSoftDrop5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsSoftDrop5PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsSoftDrop5PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsSoftDrop5PFPatJetFlavourAssociation"),
...
akCsSoftDrop5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsSoftDrop5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsSoftDrop5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsSoftDrop5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsSoftDrop5PFJets"),
...
akCsSoftDrop5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akCsSoftDrop5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCsSoftDrop5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCsSoftDrop5PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsSoftDrop5PFJetBtagging
                                                  *
                                                  akCsSoftDrop5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsSoftDrop5PFJetSequence = cms.Sequence(akCsSoftDrop5PFJetSequence_jec)
akCsSoftDrop5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDrop5PFJetAnalyzer.jetPtMin = cms.double(1)
