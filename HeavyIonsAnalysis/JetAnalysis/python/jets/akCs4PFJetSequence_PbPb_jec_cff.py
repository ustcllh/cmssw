...
#akCs4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akCs4PFbTagger = bTaggers("akCs4PF",0.4,False,False)

#create objects locally since they dont load properly otherwise
#akCs4PFmatch = akCs4PFbTagger.match
akCs4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs4PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCs4PFNegativeCombinedSecondaryVertexV2BJetTags = akCs4PFbTagger.NegativeCombinedSecondaryVertexV2BJetTags
akCs4PFPositiveCombinedSecondaryVertexV2BJetTags = akCs4PFbTagger.PositiveCombinedSecondaryVertexV2BJetTags
...
#SUBJETDUMMY_akCs4PFSubjetImpactParameterTagInfos = akCs4PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akCs4PFSubjetJetProbabilityBJetTags = akCs4PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akCs4PFSubjetSecondaryVertexTagInfos = akCs4PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akCs4PFSubjetSecondaryVertexNegativeTagInfos = akCs4PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akCs4PFSubjetJetTracksAssociatorAtVertex = akCs4PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akCs4PFCombinedSubjetSecondaryVertexBJetTags = akCs4PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akCs4PFCombinedSubjetSecondaryVertexV2BJetTags = akCs4PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akCs4PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCs4PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCs4PFJetBtaggingNegSV = cms.Sequence(akCs4PFImpactParameterTagInfos
            ...
            * (akCs4PFNegativeSimpleSecondaryVertexHighEffBJetTags+
                ...
                akCs4PFNegativeCombinedSecondaryVertexV2BJetTags+
                akCs4PFPositiveCombinedSecondaryVertexV2BJetTags
              )
            )
...
akCs4PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCs4PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCs4PFPatJetFlavourAssociation"),
...
akCs4PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCs4PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCs4PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCs4PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCs4PFJets"),
...
akCs4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCs4PFJetID
                                                  #*
                                                  #akCs4PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akCs4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akCs4PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCs4PFJetBtagging
                                                  *
                                                  akCs4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCs4PFJetSequence_mb = cms.Sequence(akCs4PFJetSequence_mc)

akCs4PFJetSequence = cms.Sequence(akCs4PFJetSequence_jec)
akCs4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCs4PFJetAnalyzer.jetPtMin = cms.double(1)
