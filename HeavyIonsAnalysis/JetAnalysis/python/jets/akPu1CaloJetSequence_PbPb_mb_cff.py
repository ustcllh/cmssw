...
#akPu1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akPu1CalobTagger = bTaggers("akPu1Calo",0.1,False,False)

#create objects locally since they dont load properly otherwise
#akPu1Calomatch = akPu1CalobTagger.match
akPu1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
#SUBJETDUMMY_akPu1CaloSubjetImpactParameterTagInfos = akPu1CalobTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akPu1CaloSubjetJetProbabilityBJetTags = akPu1CalobTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akPu1CaloSubjetSecondaryVertexTagInfos = akPu1CalobTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akPu1CaloSubjetSecondaryVertexNegativeTagInfos = akPu1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akPu1CaloSubjetJetTracksAssociatorAtVertex = akPu1CalobTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akPu1CaloCombinedSubjetSecondaryVertexBJetTags = akPu1CalobTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akPu1CaloCombinedSubjetSecondaryVertexV2BJetTags = akPu1CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akPu1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPu1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPu1CalopatJetsWithBtagging.userData.userFloats.src += ['akPu1CaloNjettiness:tau1','akPu1CaloNjettiness:tau2','akPu1CaloNjettiness:tau3']
...
akPu1CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPu1CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPu1CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPu1CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPu1CaloJets"),
...
akPu1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPu1CaloJetID
                                                  #*
                                                  #akPu1CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPu1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akPu1CaloJetTracksAssociatorAtVertex
                                                  *
                                                  akPu1CaloJetBtagging
                                                  *
                                                  akPu1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akPu1CaloJetSequence_mb = cms.Sequence(akPu1CaloJetSequence_mc)

akPu1CaloJetSequence = cms.Sequence(akPu1CaloJetSequence_mb)
