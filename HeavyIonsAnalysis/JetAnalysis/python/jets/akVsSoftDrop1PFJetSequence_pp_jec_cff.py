...
#akVsSoftDrop1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akVsSoftDrop1PFbTagger = bTaggers("akVsSoftDrop1PF",0.1,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop1PFmatch = akVsSoftDrop1PFbTagger.match
akVsSoftDrop1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop1PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akVsSoftDrop1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
