...
#akFilter4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akFilter4CalobTagger = bTaggers("akFilter4Calo",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akFilter4Calomatch = akFilter4CalobTagger.match
akFilter4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter4CaloSubjetSecondaryVertexNegativeTagInfos = akFilter4CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter4CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter4CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter4CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter4CaloJetSequence = cms.Sequence(akFilter4CaloJetSequence_jec)
akFilter4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter4CaloJetAnalyzer.jetPtMin = cms.double(1)
