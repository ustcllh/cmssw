...
#akPuSoftDropZ05B151PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akPuSoftDropZ05B151PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B151PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropZ05B151PFJetSequence = cms.Sequence(akPuSoftDropZ05B151PFJetSequence_jec)
akPuSoftDropZ05B151PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropZ05B151PFJetAnalyzer.jetPtMin = cms.double(1)
