...
#akVsSoftDrop5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akVsSoftDrop5PFbTagger = bTaggers("akVsSoftDrop5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop5PFmatch = akVsSoftDrop5PFbTagger.match
akVsSoftDrop5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVsSoftDrop5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop5PFJetSequence = cms.Sequence(akVsSoftDrop5PFJetSequence_mb)
