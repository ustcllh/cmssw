...
akCs6PFmatchGroomed = patJetGenJetMatch.clone(
...
#akCs6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akCs6PFbTagger = bTaggers("akCs6PF",0.6,True,False)

#create objects locally since they dont load properly otherwise
#akCs6PFmatch = akCs6PFbTagger.match
akCs6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs6PFJets"), matched = cms.InputTag("genParticles"))
...
#SUBJETDUMMY_akCs6PFSubjetImpactParameterTagInfos = akCs6PFbTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akCs6PFSubjetJetProbabilityBJetTags = akCs6PFbTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akCs6PFSubjetSecondaryVertexTagInfos = akCs6PFbTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akCs6PFSubjetSecondaryVertexNegativeTagInfos = akCs6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akCs6PFSubjetJetTracksAssociatorAtVertex = akCs6PFbTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akCs6PFCombinedSubjetSecondaryVertexBJetTags = akCs6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akCs6PFCombinedSubjetSecondaryVertexV2BJetTags = akCs6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akCs6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCs6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCs6PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCs6PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCs6PFPatJetFlavourAssociation"),
...
akCs6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCs6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCs6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCs6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCs6PFJets"),
...
akCs6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCs6PFJetID
                                                  #*
                                                  #akCs6PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCs6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akCs6PFJetSequence = cms.Sequence(akCs6PFJetSequence_jec)
akCs6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCs6PFJetAnalyzer.jetPtMin = cms.double(1)
