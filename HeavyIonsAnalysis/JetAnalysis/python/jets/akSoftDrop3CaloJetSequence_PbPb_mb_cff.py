...
#akSoftDrop3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akSoftDrop3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop3CaloJetSequence = cms.Sequence(akSoftDrop3CaloJetSequence_mb)
