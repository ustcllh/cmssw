...
akPuSoftDrop4PFpatJetsWithBtagging.userData.userFloats.src += ['akPuSoftDrop4PFJets:sym']
akPuSoftDrop4PFpatJetsWithBtagging.userData.userInts.src += ['akPuSoftDrop4PFJets:droppedBranches']
