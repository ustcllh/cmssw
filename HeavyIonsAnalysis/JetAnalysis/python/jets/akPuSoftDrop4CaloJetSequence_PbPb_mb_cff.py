...
#akPuSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akPuSoftDrop4CalobTagger = bTaggers("akPuSoftDrop4Calo",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop4Calomatch = akPuSoftDrop4CalobTagger.match
akPuSoftDrop4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop4CaloSubjetImpactParameterTagInfos = akPuSoftDrop4CalobTagger.SubjetImpactParameterTagInfos
akPuSoftDrop4CaloSubjetJetProbabilityBJetTags = akPuSoftDrop4CalobTagger.SubjetJetProbabilityBJetTags
akPuSoftDrop4CaloSubjetSecondaryVertexTagInfos = akPuSoftDrop4CalobTagger.SubjetSecondaryVertexTagInfos
akPuSoftDrop4CaloSubjetSecondaryVertexNegativeTagInfos = akPuSoftDrop4CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuSoftDrop4CaloSubjetJetTracksAssociatorAtVertex = akPuSoftDrop4CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuSoftDrop4CaloCombinedSubjetSecondaryVertexBJetTags = akPuSoftDrop4CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuSoftDrop4CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuSoftDrop4CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuSoftDrop4CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuSoftDrop4CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuSoftDrop4CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuSoftDrop4CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuSoftDrop4CaloPatJetFlavourAssociation"),
...
akPuSoftDrop4CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuSoftDrop4CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuSoftDrop4CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuSoftDrop4CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuSoftDrop4CaloJets"),
...
akPuSoftDrop4CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuSoftDrop4CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuSoftDrop4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop4CaloJetSequence = cms.Sequence(akPuSoftDrop4CaloJetSequence_mb)
