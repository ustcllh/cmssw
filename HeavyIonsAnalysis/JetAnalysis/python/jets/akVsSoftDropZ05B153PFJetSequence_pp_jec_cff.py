...
#akVsSoftDropZ05B153PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))
...
akVsSoftDropZ05B153PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B153PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B153PFJetSequence = cms.Sequence(akVsSoftDropZ05B153PFJetSequence_jec)
akVsSoftDropZ05B153PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B153PFJetAnalyzer.jetPtMin = cms.double(1)
