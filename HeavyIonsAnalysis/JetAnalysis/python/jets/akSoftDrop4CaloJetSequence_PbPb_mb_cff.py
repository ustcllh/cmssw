...
#akSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akSoftDrop4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop4CaloJetSequence = cms.Sequence(akSoftDrop4CaloJetSequence_mb)
