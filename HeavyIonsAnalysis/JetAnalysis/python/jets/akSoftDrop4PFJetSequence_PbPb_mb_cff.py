...
#akSoftDrop4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akSoftDrop4PFbTagger = bTaggers("akSoftDrop4PF",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop4PFmatch = akSoftDrop4PFbTagger.match
akSoftDrop4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop4PFJetSequence = cms.Sequence(akSoftDrop4PFJetSequence_mb)
