...
#akFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akFilter6PFbTagger = bTaggers("akFilter6PF",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akFilter6PFmatch = akFilter6PFbTagger.match
akFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter6PFJets"), matched = cms.InputTag("genParticles"))
