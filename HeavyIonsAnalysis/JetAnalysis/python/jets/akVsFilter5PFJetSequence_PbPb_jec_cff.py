...
#akVsFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akVsFilter5PFbTagger = bTaggers("akVsFilter5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter5PFmatch = akVsFilter5PFbTagger.match
akVsFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter5PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter5PFSubjetImpactParameterTagInfos = akVsFilter5PFbTagger.SubjetImpactParameterTagInfos
akVsFilter5PFSubjetJetProbabilityBJetTags = akVsFilter5PFbTagger.SubjetJetProbabilityBJetTags
akVsFilter5PFSubjetSecondaryVertexTagInfos = akVsFilter5PFbTagger.SubjetSecondaryVertexTagInfos
akVsFilter5PFSubjetSecondaryVertexNegativeTagInfos = akVsFilter5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter5PFSubjetJetTracksAssociatorAtVertex = akVsFilter5PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter5PFCombinedSubjetSecondaryVertexBJetTags = akVsFilter5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter5PFCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter5PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter5PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter5PFPatJetFlavourAssociation"),
...
akVsFilter5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter5PFJets"),
...
akVsFilter5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVsFilter5PFJetID
                                                  #*
                                                  #akVsFilter5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter5PFJetSequence = cms.Sequence(akVsFilter5PFJetSequence_jec)
akVsFilter5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter5PFJetAnalyzer.jetPtMin = cms.double(1)
