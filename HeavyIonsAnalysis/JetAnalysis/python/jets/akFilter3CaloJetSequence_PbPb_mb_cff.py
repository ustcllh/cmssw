...
#akFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akFilter3CalobTagger = bTaggers("akFilter3Calo",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akFilter3Calomatch = akFilter3CalobTagger.match
akFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter3CaloJetSequence = cms.Sequence(akFilter3CaloJetSequence_mb)
