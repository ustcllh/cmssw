...
#akPuSoftDrop5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akPuSoftDrop5PFbTagger = bTaggers("akPuSoftDrop5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop5PFmatch = akPuSoftDrop5PFbTagger.match
akPuSoftDrop5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuSoftDrop5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop5PFJetSequence = cms.Sequence(akPuSoftDrop5PFJetSequence_mb)
