...
#akVsSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akVsSoftDrop6CalobTagger = bTaggers("akVsSoftDrop6Calo",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop6Calomatch = akVsSoftDrop6CalobTagger.match
akVsSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop6CaloSubjetImpactParameterTagInfos = akVsSoftDrop6CalobTagger.SubjetImpactParameterTagInfos
akVsSoftDrop6CaloSubjetJetProbabilityBJetTags = akVsSoftDrop6CalobTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop6CaloSubjetSecondaryVertexTagInfos = akVsSoftDrop6CalobTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop6CaloSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop6CaloSubjetJetTracksAssociatorAtVertex = akVsSoftDrop6CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop6CaloCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop6CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop6CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop6CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop6CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop6CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop6CaloPatJetFlavourAssociation"),
...
akVsSoftDrop6CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop6CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop6CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop6CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop6CaloJets"),
...
akVsSoftDrop6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop6CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsSoftDrop6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop6CaloJetSequence = cms.Sequence(akVsSoftDrop6CaloJetSequence_mb)
