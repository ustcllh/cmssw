...
akVsSoftDrop6CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop6CaloJets:sym']
akVsSoftDrop6CalopatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop6CaloJets:droppedBranches']
