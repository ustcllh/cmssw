...
#akSoftDropZ05B151Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akSoftDropZ05B151Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B151CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDropZ05B151CaloJetSequence = cms.Sequence(akSoftDropZ05B151CaloJetSequence_jec)
akSoftDropZ05B151CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B151CaloJetAnalyzer.jetPtMin = cms.double(1)
