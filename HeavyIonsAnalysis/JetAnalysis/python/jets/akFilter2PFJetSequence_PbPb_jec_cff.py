...
akFilter2PFJetSequence = cms.Sequence(akFilter2PFJetSequence_jec)
akFilter2PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter2PFJetAnalyzer.jetPtMin = cms.double(1)
