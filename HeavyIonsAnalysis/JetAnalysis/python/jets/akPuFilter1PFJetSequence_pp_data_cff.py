...
#akPuFilter1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akPuFilter1PFbTagger = bTaggers("akPuFilter1PF",0.1,True,True)

#create objects locally since they dont load properly otherwise
#akPuFilter1PFmatch = akPuFilter1PFbTagger.match
akPuFilter1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter1PFJets"), matched = cms.InputTag("genParticles"))
...
akPuFilter1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akPuFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuFilter1PFJetSequence = cms.Sequence(akPuFilter1PFJetSequence_data)
