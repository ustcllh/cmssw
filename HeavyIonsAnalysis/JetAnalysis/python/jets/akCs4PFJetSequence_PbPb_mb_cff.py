...
#akCs4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akCs4PFbTagger = bTaggers("akCs4PF",0.4,False,False)

#create objects locally since they dont load properly otherwise
#akCs4PFmatch = akCs4PFbTagger.match
akCs4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCs4PFJetSequence = cms.Sequence(akCs4PFJetSequence_mb)
