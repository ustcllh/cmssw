...
#akCsFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akCsFilter2PFbTagger = bTaggers("akCsFilter2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akCsFilter2PFmatch = akCsFilter2PFbTagger.match
akCsFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akCsFilter2PFJetSequence = cms.Sequence(akCsFilter2PFJetSequence_mb)
