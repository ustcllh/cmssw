...
#akVsSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akVsSoftDrop4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop4CaloJetSequence = cms.Sequence(akVsSoftDrop4CaloJetSequence_mb)
