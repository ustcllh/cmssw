...
#akCsSoftDrop5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akCsSoftDrop5PFbTagger = bTaggers("akCsSoftDrop5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop5PFmatch = akCsSoftDrop5PFbTagger.match
akCsSoftDrop5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDrop5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsSoftDrop5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akCsSoftDrop5PFJetSequence = cms.Sequence(akCsSoftDrop5PFJetSequence_mb)
