...
akCs6PFbTagger = bTaggers("akCs6PF",0.6,False,False)

#create objects locally since they dont load properly otherwise
#akCs6PFmatch = akCs6PFbTagger.match
akCs6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCs6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCs6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
