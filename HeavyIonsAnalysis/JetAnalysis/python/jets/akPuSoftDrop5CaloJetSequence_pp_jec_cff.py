...
#akPuSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akPuSoftDrop5CalobTagger = bTaggers("akPuSoftDrop5Calo",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop5Calomatch = akPuSoftDrop5CalobTagger.match
akPuSoftDrop5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop5CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDrop5CaloSubjetImpactParameterTagInfos = akPuSoftDrop5CalobTagger.SubjetImpactParameterTagInfos
akPuSoftDrop5CaloSubjetJetProbabilityBJetTags = akPuSoftDrop5CalobTagger.SubjetJetProbabilityBJetTags
akPuSoftDrop5CaloSubjetSecondaryVertexTagInfos = akPuSoftDrop5CalobTagger.SubjetSecondaryVertexTagInfos
akPuSoftDrop5CaloSubjetSecondaryVertexNegativeTagInfos = akPuSoftDrop5CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuSoftDrop5CaloSubjetJetTracksAssociatorAtVertex = akPuSoftDrop5CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuSoftDrop5CaloCombinedSubjetSecondaryVertexBJetTags = akPuSoftDrop5CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuSoftDrop5CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuSoftDrop5CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuSoftDrop5CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuSoftDrop5CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuSoftDrop5CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuSoftDrop5CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuSoftDrop5CaloPatJetFlavourAssociation"),
...
akPuSoftDrop5CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuSoftDrop5CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuSoftDrop5CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuSoftDrop5CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuSoftDrop5CaloJets"),
...
akPuSoftDrop5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuSoftDrop5CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akPuSoftDrop5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuSoftDrop5CaloJetSequence = cms.Sequence(akPuSoftDrop5CaloJetSequence_jec)
akPuSoftDrop5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDrop5CaloJetAnalyzer.jetPtMin = cms.double(1)
