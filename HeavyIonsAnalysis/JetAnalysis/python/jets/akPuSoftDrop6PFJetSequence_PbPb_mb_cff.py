...
#akPuSoftDrop6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akPuSoftDrop6PFbTagger = bTaggers("akPuSoftDrop6PF",0.6)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop6PFmatch = akPuSoftDrop6PFbTagger.match
akPuSoftDrop6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop6PFJetSequence = cms.Sequence(akPuSoftDrop6PFJetSequence_mb)
