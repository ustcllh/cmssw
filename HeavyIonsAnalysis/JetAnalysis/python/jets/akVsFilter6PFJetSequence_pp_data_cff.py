...
#akVsFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akVsFilter6PFbTagger = bTaggers("akVsFilter6PF",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akVsFilter6PFmatch = akVsFilter6PFbTagger.match
akVsFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter6PFJets"), matched = cms.InputTag("genParticles"))
...
akVsFilter6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akVsFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsFilter6PFJetSequence = cms.Sequence(akVsFilter6PFJetSequence_data)
