...
#akCsSoftDrop4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))

akCsSoftDrop4PFbTagger = bTaggers("akCsSoftDrop4PF",0.4,True,True)
...
akCsSoftDrop4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akCsSoftDrop4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
