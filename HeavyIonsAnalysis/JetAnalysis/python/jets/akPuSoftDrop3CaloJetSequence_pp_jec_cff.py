...
#akPuSoftDrop3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akPuSoftDrop3CalobTagger = bTaggers("akPuSoftDrop3Calo",0.3,True,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop3Calomatch = akPuSoftDrop3CalobTagger.match
akPuSoftDrop3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop3CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDrop3CaloSubjetImpactParameterTagInfos = akPuSoftDrop3CalobTagger.SubjetImpactParameterTagInfos
akPuSoftDrop3CaloSubjetJetProbabilityBJetTags = akPuSoftDrop3CalobTagger.SubjetJetProbabilityBJetTags
akPuSoftDrop3CaloSubjetSecondaryVertexTagInfos = akPuSoftDrop3CalobTagger.SubjetSecondaryVertexTagInfos
akPuSoftDrop3CaloSubjetSecondaryVertexNegativeTagInfos = akPuSoftDrop3CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akPuSoftDrop3CaloSubjetJetTracksAssociatorAtVertex = akPuSoftDrop3CalobTagger.SubjetJetTracksAssociatorAtVertex
akPuSoftDrop3CaloCombinedSubjetSecondaryVertexBJetTags = akPuSoftDrop3CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akPuSoftDrop3CaloCombinedSubjetSecondaryVertexV2BJetTags = akPuSoftDrop3CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuSoftDrop3CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuSoftDrop3CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuSoftDrop3CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuSoftDrop3CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuSoftDrop3CaloPatJetFlavourAssociation"),
...
akPuSoftDrop3CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuSoftDrop3CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuSoftDrop3CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuSoftDrop3CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuSoftDrop3CaloJets"),
...
akPuSoftDrop3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akPuSoftDrop3CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akPuSoftDrop3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuSoftDrop3CaloJetSequence = cms.Sequence(akPuSoftDrop3CaloJetSequence_jec)
akPuSoftDrop3CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDrop3CaloJetAnalyzer.jetPtMin = cms.double(1)
