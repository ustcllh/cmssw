...
#akSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop6CaloJetSequence = cms.Sequence(akSoftDrop6CaloJetSequence_mb)
