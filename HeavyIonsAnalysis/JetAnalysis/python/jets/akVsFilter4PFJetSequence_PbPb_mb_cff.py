...
#akVsFilter4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akVsFilter4PFbTagger = bTaggers("akVsFilter4PF",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter4PFmatch = akVsFilter4PFbTagger.match
akVsFilter4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter4PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVsFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter4PFJetSequence = cms.Sequence(akVsFilter4PFJetSequence_mb)
