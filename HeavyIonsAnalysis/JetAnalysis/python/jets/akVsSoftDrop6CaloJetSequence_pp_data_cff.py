...
#akVsSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akVsSoftDrop6CalobTagger = bTaggers("akVsSoftDrop6Calo",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop6Calomatch = akVsSoftDrop6CalobTagger.match
akVsSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop6CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akVsSoftDrop6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsSoftDrop6CaloJetSequence = cms.Sequence(akVsSoftDrop6CaloJetSequence_data)
