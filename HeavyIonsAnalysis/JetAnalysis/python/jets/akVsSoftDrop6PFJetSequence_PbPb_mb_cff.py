...
#akVsSoftDrop6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akVsSoftDrop6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop6PFJetSequence = cms.Sequence(akVsSoftDrop6PFJetSequence_mb)
