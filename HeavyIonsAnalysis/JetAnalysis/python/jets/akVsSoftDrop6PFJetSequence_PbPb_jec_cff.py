...
#akVsSoftDrop6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akVsSoftDrop6PFbTagger = bTaggers("akVsSoftDrop6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop6PFmatch = akVsSoftDrop6PFbTagger.match
akVsSoftDrop6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDrop6PFSubjetImpactParameterTagInfos = akVsSoftDrop6PFbTagger.SubjetImpactParameterTagInfos
akVsSoftDrop6PFSubjetJetProbabilityBJetTags = akVsSoftDrop6PFbTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop6PFSubjetSecondaryVertexTagInfos = akVsSoftDrop6PFbTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop6PFSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop6PFSubjetJetTracksAssociatorAtVertex = akVsSoftDrop6PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop6PFCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop6PFCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop6PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop6PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop6PFPatJetFlavourAssociation"),
...
akVsSoftDrop6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop6PFJets"),
...
akVsSoftDrop6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop6PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsSoftDrop6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop6PFJetSequence = cms.Sequence(akVsSoftDrop6PFJetSequence_jec)
akVsSoftDrop6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDrop6PFJetAnalyzer.jetPtMin = cms.double(1)
