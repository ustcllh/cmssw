...
#akVsFilter1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akVsFilter1PFbTagger = bTaggers("akVsFilter1PF",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter1PFmatch = akVsFilter1PFbTagger.match
akVsFilter1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter1PFJetSequence = cms.Sequence(akVsFilter1PFJetSequence_mb)
