...
akFilter6CaloJetSequence = cms.Sequence(akFilter6CaloJetSequence_jec)
akFilter6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter6CaloJetAnalyzer.jetPtMin = cms.double(1)
