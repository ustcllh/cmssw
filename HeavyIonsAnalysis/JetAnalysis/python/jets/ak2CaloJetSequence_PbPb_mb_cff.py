...
#ak2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

ak2CalobTagger = bTaggers("ak2Calo",0.2,False,False)
...
ak2CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
ak2CaloJetSequence = cms.Sequence(ak2CaloJetSequence_mb)
