...
#akVsSoftDrop3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akVsSoftDrop3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop3CaloJetSequence = cms.Sequence(akVsSoftDrop3CaloJetSequence_mb)
