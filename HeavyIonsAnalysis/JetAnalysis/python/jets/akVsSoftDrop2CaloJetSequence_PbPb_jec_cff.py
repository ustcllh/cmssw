...
akVsSoftDrop2CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop2CaloJets:sym']
akVsSoftDrop2CalopatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop2CaloJets:droppedBranches']
