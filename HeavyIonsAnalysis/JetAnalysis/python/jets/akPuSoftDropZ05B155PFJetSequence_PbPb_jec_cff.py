...
#akPuSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))
...
akPuSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B155PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropZ05B155PFJetSequence = cms.Sequence(akPuSoftDropZ05B155PFJetSequence_jec)
akPuSoftDropZ05B155PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropZ05B155PFJetAnalyzer.jetPtMin = cms.double(1)
