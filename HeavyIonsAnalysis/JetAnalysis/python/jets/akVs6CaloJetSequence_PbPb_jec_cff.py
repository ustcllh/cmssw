...
akVs6CaloJetSequence = cms.Sequence(akVs6CaloJetSequence_jec)
akVs6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVs6CaloJetAnalyzer.jetPtMin = cms.double(1)
