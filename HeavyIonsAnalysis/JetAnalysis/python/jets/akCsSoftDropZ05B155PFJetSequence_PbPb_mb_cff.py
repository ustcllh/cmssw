...
#akCsSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akCsSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropZ05B155PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDropZ05B155PFJetSequence = cms.Sequence(akCsSoftDropZ05B155PFJetSequence_mb)
