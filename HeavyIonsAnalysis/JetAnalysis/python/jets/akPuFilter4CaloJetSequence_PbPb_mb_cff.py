...
#akPuFilter4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akPuFilter4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter4CaloJetSequence = cms.Sequence(akPuFilter4CaloJetSequence_mb)
