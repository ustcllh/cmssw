...
#akCs1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akCs1PFbTagger = bTaggers("akCs1PF",0.1,False,False)

#create objects locally since they dont load properly otherwise
#akCs1PFmatch = akCs1PFbTagger.match
akCs1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCs1PFJetSequence = cms.Sequence(akCs1PFJetSequence_mb)
