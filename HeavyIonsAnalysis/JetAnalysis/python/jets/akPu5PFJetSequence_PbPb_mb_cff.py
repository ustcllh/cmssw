...
#akPu5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akPu5PFbTagger = bTaggers("akPu5PF",0.5,False,False)

#create objects locally since they dont load properly otherwise
#akPu5PFmatch = akPu5PFbTagger.match
akPu5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPu5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPu5PFJetSequence = cms.Sequence(akPu5PFJetSequence_mb)
