...
#akCsSoftDrop1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))
...
akCsSoftDrop1PFJetSequence = cms.Sequence(akCsSoftDrop1PFJetSequence_mb)
