...
akPuSoftDropZ05B154CalomatchGroomed = patJetGenJetMatch.clone(
    src = cms.InputTag("akSoftDropZ05B154HiGenJets"),
    matched = cms.InputTag("ak4HiCleanedGenJets"),
    resolveByMatchQuality = cms.bool(False),
    maxDeltaR = 0.4
    )
...
#akPuSoftDropZ05B154Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akPuSoftDropZ05B154Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B154CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropZ05B154CaloJetSequence = cms.Sequence(akPuSoftDropZ05B154CaloJetSequence_mb)
