...
#akSoftDropZ05B156Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))
...
akSoftDropZ05B156Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B156CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B156CaloJetSequence = cms.Sequence(akSoftDropZ05B156CaloJetSequence_data)
