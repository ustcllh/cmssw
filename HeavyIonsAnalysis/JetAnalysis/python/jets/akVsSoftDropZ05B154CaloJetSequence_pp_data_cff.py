...
#akVsSoftDropZ05B154Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))
...
akVsSoftDropZ05B154Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B154CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropZ05B154CaloJetSequence = cms.Sequence(akVsSoftDropZ05B154CaloJetSequence_data)
