...
#akVsFilter1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))

akVsFilter1CalobTagger = bTaggers("akVsFilter1Calo",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter1Calomatch = akVsFilter1CalobTagger.match
akVsFilter1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter1CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter1CaloSubjetImpactParameterTagInfos = akVsFilter1CalobTagger.SubjetImpactParameterTagInfos
akVsFilter1CaloSubjetJetProbabilityBJetTags = akVsFilter1CalobTagger.SubjetJetProbabilityBJetTags
akVsFilter1CaloSubjetSecondaryVertexTagInfos = akVsFilter1CalobTagger.SubjetSecondaryVertexTagInfos
akVsFilter1CaloSubjetSecondaryVertexNegativeTagInfos = akVsFilter1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter1CaloSubjetJetTracksAssociatorAtVertex = akVsFilter1CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter1CaloCombinedSubjetSecondaryVertexBJetTags = akVsFilter1CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter1CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter1CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter1CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter1CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter1CaloPatJetFlavourAssociation"),
...
akVsFilter1CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter1CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter1CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter1CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter1CaloJets"),
...
akVsFilter1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsFilter1CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter1CaloJetSequence = cms.Sequence(akVsFilter1CaloJetSequence_jec)
akVsFilter1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter1CaloJetAnalyzer.jetPtMin = cms.double(1)
