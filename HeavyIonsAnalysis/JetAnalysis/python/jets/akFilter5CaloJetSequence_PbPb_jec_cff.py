...
#akFilter5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akFilter5CalobTagger = bTaggers("akFilter5Calo",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akFilter5Calomatch = akFilter5CalobTagger.match
akFilter5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter5CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter5CaloSubjetSecondaryVertexNegativeTagInfos = akFilter5CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter5CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter5CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter5CaloJetSequence = cms.Sequence(akFilter5CaloJetSequence_jec)
akFilter5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter5CaloJetAnalyzer.jetPtMin = cms.double(1)
