...
akFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akFilter3PFJetSequence = cms.Sequence(akFilter3PFJetSequence_mb)
