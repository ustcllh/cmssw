...
#akVsSoftDrop3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akVsSoftDrop3PFbTagger = bTaggers("akVsSoftDrop3PF",0.3,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop3PFmatch = akVsSoftDrop3PFbTagger.match
akVsSoftDrop3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop3PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akVsSoftDrop3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
