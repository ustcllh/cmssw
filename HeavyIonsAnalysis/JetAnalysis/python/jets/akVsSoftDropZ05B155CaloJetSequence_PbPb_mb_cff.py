...
#akVsSoftDropZ05B155Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akVsSoftDropZ05B155Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B155CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropZ05B155CaloJetSequence = cms.Sequence(akVsSoftDropZ05B155CaloJetSequence_mb)
