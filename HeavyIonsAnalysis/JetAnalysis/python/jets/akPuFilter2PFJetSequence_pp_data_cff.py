...
#akPuFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akPuFilter2PFbTagger = bTaggers("akPuFilter2PF",0.2,True,True)

#create objects locally since they dont load properly otherwise
#akPuFilter2PFmatch = akPuFilter2PFbTagger.match
akPuFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter2PFJets"), matched = cms.InputTag("genParticles"))
...
akPuFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akPuFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akPuFilter2PFJetSequence = cms.Sequence(akPuFilter2PFJetSequence_data)
