...
#akVs3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akVs3CalobTagger = bTaggers("akVs3Calo",0.3,False,False)

#create objects locally since they dont load properly otherwise
#akVs3Calomatch = akVs3CalobTagger.match
akVs3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVs3CaloNegativeCombinedSecondaryVertexV2BJetTags = akVs3CalobTagger.NegativeCombinedSecondaryVertexV2BJetTags
akVs3CaloPositiveCombinedSecondaryVertexV2BJetTags = akVs3CalobTagger.PositiveCombinedSecondaryVertexV2BJetTags
...
#SUBJETDUMMY_akVs3CaloSubjetImpactParameterTagInfos = akVs3CalobTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akVs3CaloSubjetJetProbabilityBJetTags = akVs3CalobTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akVs3CaloSubjetSecondaryVertexTagInfos = akVs3CalobTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akVs3CaloSubjetSecondaryVertexNegativeTagInfos = akVs3CalobTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akVs3CaloSubjetJetTracksAssociatorAtVertex = akVs3CalobTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akVs3CaloCombinedSubjetSecondaryVertexBJetTags = akVs3CalobTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akVs3CaloCombinedSubjetSecondaryVertexV2BJetTags = akVs3CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akVs3CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVs3CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVs3CaloJetBtaggingNegSV = cms.Sequence(akVs3CaloImpactParameterTagInfos
            ...
            * (akVs3CaloNegativeSimpleSecondaryVertexHighEffBJetTags+
                ...
                akVs3CaloNegativeCombinedSecondaryVertexV2BJetTags+
                akVs3CaloPositiveCombinedSecondaryVertexV2BJetTags
              )
            )
...
akVs3CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVs3CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVs3CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVs3CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVs3CaloJets"),
...
akVs3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVs3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVs3CaloJetSequence_mb = cms.Sequence(akVs3CaloJetSequence_mc)

akVs3CaloJetSequence = cms.Sequence(akVs3CaloJetSequence_mb)
