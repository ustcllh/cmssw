...
#akFilter3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akFilter3PFbTagger = bTaggers("akFilter3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akFilter3PFmatch = akFilter3PFbTagger.match
akFilter3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akFilter3PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akFilter3PFSubjetSecondaryVertexNegativeTagInfos = akFilter3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akFilter3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akFilter3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akFilter3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akFilter3PFJetSequence = cms.Sequence(akFilter3PFJetSequence_jec)
akFilter3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFilter3PFJetAnalyzer.jetPtMin = cms.double(1)
