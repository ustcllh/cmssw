...
#akVsFilter4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akVsFilter4CalobTagger = bTaggers("akVsFilter4Calo",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter4Calomatch = akVsFilter4CalobTagger.match
akVsFilter4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter4CaloSubjetImpactParameterTagInfos = akVsFilter4CalobTagger.SubjetImpactParameterTagInfos
akVsFilter4CaloSubjetJetProbabilityBJetTags = akVsFilter4CalobTagger.SubjetJetProbabilityBJetTags
akVsFilter4CaloSubjetSecondaryVertexTagInfos = akVsFilter4CalobTagger.SubjetSecondaryVertexTagInfos
akVsFilter4CaloSubjetSecondaryVertexNegativeTagInfos = akVsFilter4CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter4CaloSubjetJetTracksAssociatorAtVertex = akVsFilter4CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter4CaloCombinedSubjetSecondaryVertexBJetTags = akVsFilter4CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter4CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter4CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter4CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter4CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter4CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter4CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter4CaloPatJetFlavourAssociation"),
...
akVsFilter4CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter4CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter4CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter4CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter4CaloJets"),
...
akVsFilter4CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsFilter4CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter4CaloJetSequence = cms.Sequence(akVsFilter4CaloJetSequence_jec)
akVsFilter4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter4CaloJetAnalyzer.jetPtMin = cms.double(1)
