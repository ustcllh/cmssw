...
#akCs3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akCs3PFbTagger = bTaggers("akCs3PF",0.3,True,False)

#create objects locally since they dont load properly otherwise
#akCs3PFmatch = akCs3PFbTagger.match
akCs3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs3PFJets"), matched = cms.InputTag("genParticles"))
...
akCs3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akCs3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akCs3PFJetSequence = cms.Sequence(akCs3PFJetSequence_data)
