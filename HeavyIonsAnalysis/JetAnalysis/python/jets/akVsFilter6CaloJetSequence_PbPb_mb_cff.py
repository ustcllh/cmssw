...
#akVsFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akVsFilter6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter6CaloJetSequence = cms.Sequence(akVsFilter6CaloJetSequence_mb)
