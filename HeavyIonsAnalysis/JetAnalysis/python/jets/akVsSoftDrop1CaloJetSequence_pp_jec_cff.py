...
akVsSoftDrop1CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop1CaloJets:sym']
akVsSoftDrop1CalopatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop1CaloJets:droppedBranches']
