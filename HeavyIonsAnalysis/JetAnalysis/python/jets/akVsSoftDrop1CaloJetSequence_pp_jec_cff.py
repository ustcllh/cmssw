...
#akVsSoftDrop1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akVsSoftDrop1CalobTagger = bTaggers("akVsSoftDrop1Calo",0.1,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop1Calomatch = akVsSoftDrop1CalobTagger.match
akVsSoftDrop1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop1CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop1CaloSubjetImpactParameterTagInfos = akVsSoftDrop1CalobTagger.SubjetImpactParameterTagInfos
akVsSoftDrop1CaloSubjetJetProbabilityBJetTags = akVsSoftDrop1CalobTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop1CaloSubjetSecondaryVertexTagInfos = akVsSoftDrop1CalobTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop1CaloSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop1CaloSubjetJetTracksAssociatorAtVertex = akVsSoftDrop1CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop1CaloCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop1CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop1CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop1CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop1CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop1CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop1CaloPatJetFlavourAssociation"),
...
akVsSoftDrop1CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop1CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop1CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop1CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop1CaloJets"),
...
akVsSoftDrop1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop1CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akVsSoftDrop1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsSoftDrop1CaloJetSequence = cms.Sequence(akVsSoftDrop1CaloJetSequence_jec)
akVsSoftDrop1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDrop1CaloJetAnalyzer.jetPtMin = cms.double(1)
