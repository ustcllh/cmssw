...
#akVs5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akVs5CalobTagger = bTaggers("akVs5Calo",0.5,False,False)
...
akVs5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVs5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVs5CaloJetSequence = cms.Sequence(akVs5CaloJetSequence_data)
