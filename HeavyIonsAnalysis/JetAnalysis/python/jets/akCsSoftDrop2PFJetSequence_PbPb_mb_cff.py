...
#akCsSoftDrop2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akCsSoftDrop2PFJetSequence = cms.Sequence(akCsSoftDrop2PFJetSequence_mb)
