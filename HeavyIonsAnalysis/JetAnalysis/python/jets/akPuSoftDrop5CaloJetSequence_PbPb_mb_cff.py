...
#akPuSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akPuSoftDrop5CalobTagger = bTaggers("akPuSoftDrop5Calo",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop5Calomatch = akPuSoftDrop5CalobTagger.match
akPuSoftDrop5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuSoftDrop5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop5CaloJetSequence = cms.Sequence(akPuSoftDrop5CaloJetSequence_mb)
