...
#akVsSoftDropZ05B151Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akVsSoftDropZ05B151Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B151CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropZ05B151CaloJetSequence = cms.Sequence(akVsSoftDropZ05B151CaloJetSequence_jec)
akVsSoftDropZ05B151CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropZ05B151CaloJetAnalyzer.jetPtMin = cms.double(1)
