...
#akPuFilter6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akPuFilter6PFbTagger = bTaggers("akPuFilter6PF",0.6,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter6PFmatch = akPuFilter6PFbTagger.match
akPuFilter6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuFilter6PFSubjetImpactParameterTagInfos = akPuFilter6PFbTagger.SubjetImpactParameterTagInfos
akPuFilter6PFSubjetJetProbabilityBJetTags = akPuFilter6PFbTagger.SubjetJetProbabilityBJetTags
akPuFilter6PFSubjetSecondaryVertexTagInfos = akPuFilter6PFbTagger.SubjetSecondaryVertexTagInfos
akPuFilter6PFSubjetSecondaryVertexNegativeTagInfos = akPuFilter6PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter6PFSubjetJetTracksAssociatorAtVertex = akPuFilter6PFbTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter6PFCombinedSubjetSecondaryVertexBJetTags = akPuFilter6PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter6PFCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter6PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter6PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter6PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter6PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter6PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter6PFPatJetFlavourAssociation"),
...
akPuFilter6PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter6PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter6PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter6PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter6PFJets"),
...
akPuFilter6PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPuFilter6PFJetID
                                                  #*
                                                  #akPuFilter6PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter6PFJetSequence = cms.Sequence(akPuFilter6PFJetSequence_data)
