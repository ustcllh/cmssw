...
#akVsSoftDrop3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akVsSoftDrop3PFbTagger = bTaggers("akVsSoftDrop3PF",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop3PFmatch = akVsSoftDrop3PFbTagger.match
akVsSoftDrop3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop3PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDrop3PFSubjetImpactParameterTagInfos = akVsSoftDrop3PFbTagger.SubjetImpactParameterTagInfos
akVsSoftDrop3PFSubjetJetProbabilityBJetTags = akVsSoftDrop3PFbTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop3PFSubjetSecondaryVertexTagInfos = akVsSoftDrop3PFbTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop3PFSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop3PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop3PFSubjetJetTracksAssociatorAtVertex = akVsSoftDrop3PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop3PFCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop3PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop3PFCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop3PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop3PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop3PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop3PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop3PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop3PFPatJetFlavourAssociation"),
...
akVsSoftDrop3PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop3PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop3PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop3PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop3PFJets"),
...
akVsSoftDrop3PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop3PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsSoftDrop3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop3PFJetSequence = cms.Sequence(akVsSoftDrop3PFJetSequence_jec)
akVsSoftDrop3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDrop3PFJetAnalyzer.jetPtMin = cms.double(1)
