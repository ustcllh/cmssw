...
akVsSoftDrop3PFpatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop3PFJets:sym']
akVsSoftDrop3PFpatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop3PFJets:droppedBranches']
