...
#akVsFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))

akVsFilter2PFbTagger = bTaggers("akVsFilter2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter2PFmatch = akVsFilter2PFbTagger.match
akVsFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter2PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter2PFSubjetImpactParameterTagInfos = akVsFilter2PFbTagger.SubjetImpactParameterTagInfos
akVsFilter2PFSubjetJetProbabilityBJetTags = akVsFilter2PFbTagger.SubjetJetProbabilityBJetTags
akVsFilter2PFSubjetSecondaryVertexTagInfos = akVsFilter2PFbTagger.SubjetSecondaryVertexTagInfos
akVsFilter2PFSubjetSecondaryVertexNegativeTagInfos = akVsFilter2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter2PFSubjetJetTracksAssociatorAtVertex = akVsFilter2PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter2PFCombinedSubjetSecondaryVertexBJetTags = akVsFilter2PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter2PFCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter2PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter2PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter2PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter2PFPatJetFlavourAssociation"),
...
akVsFilter2PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter2PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter2PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter2PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter2PFJets"),
...
akVsFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVsFilter2PFJetID
                                                  #*
                                                  #akVsFilter2PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter2PFJetSequence = cms.Sequence(akVsFilter2PFJetSequence_jec)
akVsFilter2PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter2PFJetAnalyzer.jetPtMin = cms.double(1)
