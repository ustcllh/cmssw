...
#akPuSoftDrop3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPuSoftDrop3CalobTagger = bTaggers("akPuSoftDrop3Calo",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop3Calomatch = akPuSoftDrop3CalobTagger.match
akPuSoftDrop3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDrop3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuSoftDrop3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuSoftDrop3CaloJetSequence = cms.Sequence(akPuSoftDrop3CaloJetSequence_mb)
