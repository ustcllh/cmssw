...
#akSoftDropZ05B153Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))
...
akSoftDropZ05B153Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B153CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDropZ05B153CaloJetSequence = cms.Sequence(akSoftDropZ05B153CaloJetSequence_jec)
akSoftDropZ05B153CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B153CaloJetAnalyzer.jetPtMin = cms.double(1)
