...
#ak6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

ak6CalobTagger = bTaggers("ak6Calo",0.6,False,False)
...
#SUBJETDUMMY_ak6CaloSubjetSecondaryVertexNegativeTagInfos = ak6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak6CalopatJetsWithBtagging.userData.userFloats.src += ['ak6CaloNjettiness:tau1','ak6CaloNjettiness:tau2','ak6CaloNjettiness:tau3']
...
ak6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  ak6CaloJetTracksAssociatorAtVertex
                                                  *
                                                  ak6CaloJetBtagging
                                                  *
                                                  ak6CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
ak6CaloJetSequence = cms.Sequence(ak6CaloJetSequence_mb)
