...
akCsSoftDrop2PFbTagger = bTaggers("akCsSoftDrop2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akCsSoftDrop2PFmatch = akCsSoftDrop2PFbTagger.match
akCsSoftDrop2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDrop2PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDrop2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCsSoftDrop2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
