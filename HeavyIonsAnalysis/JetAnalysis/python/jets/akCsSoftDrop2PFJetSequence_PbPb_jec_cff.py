...
akCsSoftDrop2PFpatJetsWithBtagging.userData.userFloats.src += ['akCsSoftDrop2PFJets:sym']
akCsSoftDrop2PFpatJetsWithBtagging.userData.userInts.src += ['akCsSoftDrop2PFJets:droppedBranches']
