...
#akPuFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akPuFilter2PFbTagger = bTaggers("akPuFilter2PF",0.2,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter2PFmatch = akPuFilter2PFbTagger.match
akPuFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter2PFSubjetImpactParameterTagInfos = akPuFilter2PFbTagger.SubjetImpactParameterTagInfos
akPuFilter2PFSubjetJetProbabilityBJetTags = akPuFilter2PFbTagger.SubjetJetProbabilityBJetTags
akPuFilter2PFSubjetSecondaryVertexTagInfos = akPuFilter2PFbTagger.SubjetSecondaryVertexTagInfos
akPuFilter2PFSubjetSecondaryVertexNegativeTagInfos = akPuFilter2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akPuFilter2PFSubjetJetTracksAssociatorAtVertex = akPuFilter2PFbTagger.SubjetJetTracksAssociatorAtVertex
akPuFilter2PFCombinedSubjetSecondaryVertexBJetTags = akPuFilter2PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akPuFilter2PFCombinedSubjetSecondaryVertexV2BJetTags = akPuFilter2PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akPuFilter2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akPuFilter2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akPuFilter2PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akPuFilter2PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akPuFilter2PFPatJetFlavourAssociation"),
...
akPuFilter2PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuFilter2PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akPuFilter2PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akPuFilter2PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akPuFilter2PFJets"),
...
akPuFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akPuFilter2PFJetID
                                                  #*
                                                  #akPuFilter2PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akPuFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter2PFJetSequence = cms.Sequence(akPuFilter2PFJetSequence_mb)
