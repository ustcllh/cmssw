...
#akVsFilter5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akVsFilter5PFbTagger = bTaggers("akVsFilter5PF",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter5PFmatch = akVsFilter5PFbTagger.match
akVsFilter5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter5PFJetSequence = cms.Sequence(akVsFilter5PFJetSequence_mb)
