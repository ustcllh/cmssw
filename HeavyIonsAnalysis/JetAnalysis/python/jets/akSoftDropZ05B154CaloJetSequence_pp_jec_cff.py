...
#akSoftDropZ05B154Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))
...
akSoftDropZ05B154Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B154CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B154CaloJetSequence = cms.Sequence(akSoftDropZ05B154CaloJetSequence_jec)
akSoftDropZ05B154CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B154CaloJetAnalyzer.jetPtMin = cms.double(1)
