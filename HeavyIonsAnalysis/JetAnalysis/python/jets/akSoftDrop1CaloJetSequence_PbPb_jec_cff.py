...
akSoftDrop1CaloJetSequence = cms.Sequence(akSoftDrop1CaloJetSequence_jec)
akSoftDrop1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDrop1CaloJetAnalyzer.jetPtMin = cms.double(1)
