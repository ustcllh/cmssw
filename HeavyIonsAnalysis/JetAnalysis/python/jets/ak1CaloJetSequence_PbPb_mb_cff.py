...
#ak1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

ak1CalobTagger = bTaggers("ak1Calo",0.1,False,False)

#create objects locally since they dont load properly otherwise
#ak1Calomatch = ak1CalobTagger.match
ak1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("ak1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
#SUBJETDUMMY_ak1CaloSubjetSecondaryVertexNegativeTagInfos = ak1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_ak1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = ak1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
ak1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_ak1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  ak1CaloJetTracksAssociatorAtVertex
                                                  *
                                                  ak1CaloJetBtagging
                                                  *
                                                  ak1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
ak1CaloJetSequence = cms.Sequence(ak1CaloJetSequence_mb)
