...
#akVsFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akVsFilter3CalobTagger = bTaggers("akVsFilter3Calo",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter3Calomatch = akVsFilter3CalobTagger.match
akVsFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter3CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsFilter3CaloSubjetImpactParameterTagInfos = akVsFilter3CalobTagger.SubjetImpactParameterTagInfos
akVsFilter3CaloSubjetJetProbabilityBJetTags = akVsFilter3CalobTagger.SubjetJetProbabilityBJetTags
akVsFilter3CaloSubjetSecondaryVertexTagInfos = akVsFilter3CalobTagger.SubjetSecondaryVertexTagInfos
akVsFilter3CaloSubjetSecondaryVertexNegativeTagInfos = akVsFilter3CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter3CaloSubjetJetTracksAssociatorAtVertex = akVsFilter3CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter3CaloCombinedSubjetSecondaryVertexBJetTags = akVsFilter3CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter3CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter3CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter3CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter3CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter3CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter3CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter3CaloPatJetFlavourAssociation"),
...
akVsFilter3CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter3CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter3CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter3CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter3CaloJets"),
...
akVsFilter3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsFilter3CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter3CaloJetSequence = cms.Sequence(akVsFilter3CaloJetSequence_jec)
akVsFilter3CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter3CaloJetAnalyzer.jetPtMin = cms.double(1)
