...
#akPu3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPu3CalobTagger = bTaggers("akPu3Calo",0.3,False,False)

#create objects locally since they dont load properly otherwise
#akPu3Calomatch = akPu3CalobTagger.match
akPu3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPu3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPu3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPu3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPu3CaloJetSequence = cms.Sequence(akPu3CaloJetSequence_mb)
