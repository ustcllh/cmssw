...
akPuSoftDrop4PFJetSequence = cms.Sequence(akPuSoftDrop4PFJetSequence_jec)
akPuSoftDrop4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDrop4PFJetAnalyzer.jetPtMin = cms.double(1)
