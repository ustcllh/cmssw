...
#akPuFilter6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akPuFilter6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter6CaloJetSequence = cms.Sequence(akPuFilter6CaloJetSequence_mb)
