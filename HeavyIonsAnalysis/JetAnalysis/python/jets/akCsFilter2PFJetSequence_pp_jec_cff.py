...
akCsFilter2PFmatchGroomed = patJetGenJetMatch.clone(
...
#akCsFilter2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akCsFilter2PFbTagger = bTaggers("akCsFilter2PF",0.2,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter2PFmatch = akCsFilter2PFbTagger.match
akCsFilter2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter2PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter2PFSubjetImpactParameterTagInfos = akCsFilter2PFbTagger.SubjetImpactParameterTagInfos
akCsFilter2PFSubjetJetProbabilityBJetTags = akCsFilter2PFbTagger.SubjetJetProbabilityBJetTags
akCsFilter2PFSubjetSecondaryVertexTagInfos = akCsFilter2PFbTagger.SubjetSecondaryVertexTagInfos
akCsFilter2PFSubjetSecondaryVertexNegativeTagInfos = akCsFilter2PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akCsFilter2PFSubjetJetTracksAssociatorAtVertex = akCsFilter2PFbTagger.SubjetJetTracksAssociatorAtVertex
akCsFilter2PFCombinedSubjetSecondaryVertexBJetTags = akCsFilter2PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akCsFilter2PFCombinedSubjetSecondaryVertexV2BJetTags = akCsFilter2PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akCsFilter2PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter2PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter2PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsFilter2PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsFilter2PFPatJetFlavourAssociation"),
...
akCsFilter2PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akCsFilter2PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akCsFilter2PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akCsFilter2PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akCsFilter2PFJets"),
...
akCsFilter2PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCsFilter2PFJetID
                                                  #*
                                                  #akCsFilter2PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCsFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCsFilter2PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsFilter2PFJetBtagging
                                                  *
                                                  akCsFilter2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsFilter2PFJetSequence = cms.Sequence(akCsFilter2PFJetSequence_jec)
akCsFilter2PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter2PFJetAnalyzer.jetPtMin = cms.double(1)
