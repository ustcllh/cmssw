...
#akSoftDropZ05B155Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akSoftDropZ05B155Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B155CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B155CaloJetSequence = cms.Sequence(akSoftDropZ05B155CaloJetSequence_jec)
akSoftDropZ05B155CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B155CaloJetAnalyzer.jetPtMin = cms.double(1)
