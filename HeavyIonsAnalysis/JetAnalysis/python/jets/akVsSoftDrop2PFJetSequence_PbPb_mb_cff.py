...
#akVsSoftDrop2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akVsSoftDrop2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDrop2PFJetSequence = cms.Sequence(akVsSoftDrop2PFJetSequence_mb)
