...
akCsFilter1PFmatchGroomed = patJetGenJetMatch.clone(
...
#akCsFilter1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akCsFilter1PFbTagger = bTaggers("akCsFilter1PF",0.1,True,True)

#create objects locally since they dont load properly otherwise
#akCsFilter1PFmatch = akCsFilter1PFbTagger.match
akCsFilter1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsFilter1PFJets"), matched = cms.InputTag("genParticles"))
...
akCsFilter1PFSubjetSecondaryVertexNegativeTagInfos = akCsFilter1PFbTagger.SubjetSecondaryVertexNegativeTagInfos
...
akCsFilter1PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akCsFilter1PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akCsFilter1PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akCsFilter1PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akCsFilter1PFPatJetFlavourAssociation"),
...
akCsFilter1PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akCsFilter1PFJetID
                                                  #*
                                                  #akCsFilter1PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akCsFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
                                                  akCsFilter1PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCsFilter1PFJetBtagging
                                                  *
                                                  akCsFilter1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCsFilter1PFJetSequence = cms.Sequence(akCsFilter1PFJetSequence_jec)
akCsFilter1PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsFilter1PFJetAnalyzer.jetPtMin = cms.double(1)
