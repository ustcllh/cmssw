...
#akSoftDropZ05B156PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))
...
akSoftDropZ05B156PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropZ05B156PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropZ05B156PFJetSequence = cms.Sequence(akSoftDropZ05B156PFJetSequence_jec)
akSoftDropZ05B156PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropZ05B156PFJetAnalyzer.jetPtMin = cms.double(1)
