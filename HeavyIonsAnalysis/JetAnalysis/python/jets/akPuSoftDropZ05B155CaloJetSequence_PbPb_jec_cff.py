...
#akPuSoftDropZ05B155Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))
...
akPuSoftDropZ05B155Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B155CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropZ05B155CaloJetSequence = cms.Sequence(akPuSoftDropZ05B155CaloJetSequence_jec)
akPuSoftDropZ05B155CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropZ05B155CaloJetAnalyzer.jetPtMin = cms.double(1)
