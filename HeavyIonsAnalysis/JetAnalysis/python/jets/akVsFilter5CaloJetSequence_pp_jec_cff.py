...
#akVsFilter5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akVsFilter5CalobTagger = bTaggers("akVsFilter5Calo",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akVsFilter5Calomatch = akVsFilter5CalobTagger.match
akVsFilter5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter5CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsFilter5CaloSubjetImpactParameterTagInfos = akVsFilter5CalobTagger.SubjetImpactParameterTagInfos
akVsFilter5CaloSubjetJetProbabilityBJetTags = akVsFilter5CalobTagger.SubjetJetProbabilityBJetTags
akVsFilter5CaloSubjetSecondaryVertexTagInfos = akVsFilter5CalobTagger.SubjetSecondaryVertexTagInfos
akVsFilter5CaloSubjetSecondaryVertexNegativeTagInfos = akVsFilter5CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsFilter5CaloSubjetJetTracksAssociatorAtVertex = akVsFilter5CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsFilter5CaloCombinedSubjetSecondaryVertexBJetTags = akVsFilter5CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsFilter5CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsFilter5CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsFilter5CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsFilter5CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsFilter5CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsFilter5CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsFilter5CaloPatJetFlavourAssociation"),
...
akVsFilter5CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsFilter5CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsFilter5CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsFilter5CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsFilter5CaloJets"),
...
akVsFilter5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsFilter5CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akVsFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsFilter5CaloJetSequence = cms.Sequence(akVsFilter5CaloJetSequence_jec)
akVsFilter5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsFilter5CaloJetAnalyzer.jetPtMin = cms.double(1)
