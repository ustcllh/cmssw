...
#akVsFilter5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akVsFilter5CalobTagger = bTaggers("akVsFilter5Calo",0.5,False,True)

#create objects locally since they dont load properly otherwise
#akVsFilter5Calomatch = akVsFilter5CalobTagger.match
akVsFilter5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsFilter5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsFilter5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVsFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsFilter5CaloJetSequence = cms.Sequence(akVsFilter5CaloJetSequence_mb)
