...
#akPuSoftDrop6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akPuSoftDrop6CalobTagger = bTaggers("akPuSoftDrop6Calo",0.6,True,True)

#create objects locally since they dont load properly otherwise
#akPuSoftDrop6Calomatch = akPuSoftDrop6CalobTagger.match
akPuSoftDrop6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDrop6CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDrop6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akPuSoftDrop6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
