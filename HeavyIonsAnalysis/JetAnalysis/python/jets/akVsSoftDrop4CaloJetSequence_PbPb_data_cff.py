...
#akVsSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akVsSoftDrop4CalobTagger = bTaggers("akVsSoftDrop4Calo",0.4,False,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop4Calomatch = akVsSoftDrop4CalobTagger.match
akVsSoftDrop4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDrop4CaloSubjetImpactParameterTagInfos = akVsSoftDrop4CalobTagger.SubjetImpactParameterTagInfos
akVsSoftDrop4CaloSubjetJetProbabilityBJetTags = akVsSoftDrop4CalobTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop4CaloSubjetSecondaryVertexTagInfos = akVsSoftDrop4CalobTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop4CaloSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop4CalobTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop4CaloSubjetJetTracksAssociatorAtVertex = akVsSoftDrop4CalobTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop4CaloCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop4CalobTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop4CaloCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop4CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop4CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop4CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop4CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop4CaloJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop4CaloPatJetFlavourAssociation"),
...
akVsSoftDrop4CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop4CalopatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop4CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop4CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop4CaloJets"),
...
akVsSoftDrop4CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop4CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVsSoftDrop4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVsSoftDrop4CaloJetSequence = cms.Sequence(akVsSoftDrop4CaloJetSequence_data)
