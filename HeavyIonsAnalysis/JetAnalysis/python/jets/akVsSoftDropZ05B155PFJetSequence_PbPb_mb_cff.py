...
#akVsSoftDropZ05B155PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akVsSoftDropZ05B155PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropZ05B155PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropZ05B155PFJetSequence = cms.Sequence(akVsSoftDropZ05B155PFJetSequence_mb)
