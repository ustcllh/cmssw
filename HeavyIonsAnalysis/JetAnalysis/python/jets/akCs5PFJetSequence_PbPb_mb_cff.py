...
#akCs5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akCs5PFbTagger = bTaggers("akCs5PF",0.5,False,False)

#create objects locally since they dont load properly otherwise
#akCs5PFmatch = akCs5PFbTagger.match
akCs5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCs5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCs5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akCs5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
                                                  akCs5PFJetTracksAssociatorAtVertex
                                                  *
                                                  akCs5PFJetBtagging
                                                  *
                                                  akCs5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  *
...
akCs5PFJetSequence = cms.Sequence(akCs5PFJetSequence_mb)
