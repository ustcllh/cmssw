...
#akVsSoftDrop5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akVsSoftDrop5PFbTagger = bTaggers("akVsSoftDrop5PF",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop5PFmatch = akVsSoftDrop5PFbTagger.match
akVsSoftDrop5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop5PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop5PFSubjetImpactParameterTagInfos = akVsSoftDrop5PFbTagger.SubjetImpactParameterTagInfos
akVsSoftDrop5PFSubjetJetProbabilityBJetTags = akVsSoftDrop5PFbTagger.SubjetJetProbabilityBJetTags
akVsSoftDrop5PFSubjetSecondaryVertexTagInfos = akVsSoftDrop5PFbTagger.SubjetSecondaryVertexTagInfos
akVsSoftDrop5PFSubjetSecondaryVertexNegativeTagInfos = akVsSoftDrop5PFbTagger.SubjetSecondaryVertexNegativeTagInfos
akVsSoftDrop5PFSubjetJetTracksAssociatorAtVertex = akVsSoftDrop5PFbTagger.SubjetJetTracksAssociatorAtVertex
akVsSoftDrop5PFCombinedSubjetSecondaryVertexBJetTags = akVsSoftDrop5PFbTagger.CombinedSubjetSecondaryVertexBJetTags
akVsSoftDrop5PFCombinedSubjetSecondaryVertexV2BJetTags = akVsSoftDrop5PFbTagger.CombinedSubjetSecondaryVertexV2BJetTags
akVsSoftDrop5PFCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVsSoftDrop5PFbTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVsSoftDrop5PFpatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("akVsSoftDrop5PFJets"),
        ...
        JetPartonMapSource   = cms.InputTag("akVsSoftDrop5PFPatJetFlavourAssociation"),
...
akVsSoftDrop5PFJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVsSoftDrop5PFpatJetsWithBtagging"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVsSoftDrop5PFPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVsSoftDrop5PFPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVsSoftDrop5PFJets"),
...
akVsSoftDrop5PFJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #akVsSoftDrop5PFPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          akVsSoftDrop5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsSoftDrop5PFJetSequence = cms.Sequence(akVsSoftDrop5PFJetSequence_jec)
akVsSoftDrop5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDrop5PFJetAnalyzer.jetPtMin = cms.double(1)
