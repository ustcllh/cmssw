...
akVsSoftDrop5PFpatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop5PFJets:sym']
akVsSoftDrop5PFpatJetsWithBtagging.userData.userInts.src += ['akVsSoftDrop5PFJets:droppedBranches']
