...
#akPuSoftDropZ05B151Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))
...
akPuSoftDropZ05B151Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B151CaloJets"), matched = cms.InputTag("genParticles"))
