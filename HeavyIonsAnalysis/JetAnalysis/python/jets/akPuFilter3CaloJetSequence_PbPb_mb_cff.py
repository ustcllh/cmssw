...
#akPuFilter3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPuFilter3CalobTagger = bTaggers("akPuFilter3Calo",0.3,False,True)

#create objects locally since they dont load properly otherwise
#akPuFilter3Calomatch = akPuFilter3CalobTagger.match
akPuFilter3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuFilter3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuFilter3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akPuFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akPuFilter3CaloJetSequence = cms.Sequence(akPuFilter3CaloJetSequence_mb)
