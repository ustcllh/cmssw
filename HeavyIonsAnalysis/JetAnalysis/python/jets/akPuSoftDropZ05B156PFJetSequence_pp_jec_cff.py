...
#akPuSoftDropZ05B156PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))
...
akPuSoftDropZ05B156PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropZ05B156PFJets"), matched = cms.InputTag("genParticles"))
