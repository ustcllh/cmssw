...
#akVs6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akVs6CalobTagger = bTaggers("akVs6Calo",0.6,False,False)

#create objects locally since they dont load properly otherwise
#akVs6Calomatch = akVs6CalobTagger.match
akVs6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVs6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
#SUBJETDUMMY_akVs6CaloSubjetSecondaryVertexNegativeTagInfos = akVs6CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
#SUBJETDUMMY_akVs6CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVs6CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVs6CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akVs6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVs6CaloJetSequence = cms.Sequence(akVs6CaloJetSequence_mb)
