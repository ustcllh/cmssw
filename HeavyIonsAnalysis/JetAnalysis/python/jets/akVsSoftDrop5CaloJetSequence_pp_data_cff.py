...
#akVsSoftDrop5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akVsSoftDrop5CalobTagger = bTaggers("akVsSoftDrop5Calo",0.5,True,True)

#create objects locally since they dont load properly otherwise
#akVsSoftDrop5Calomatch = akVsSoftDrop5CalobTagger.match
akVsSoftDrop5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDrop5CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDrop5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          akVsSoftDrop5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  *
...
akVsSoftDrop5CaloJetSequence = cms.Sequence(akVsSoftDrop5CaloJetSequence_data)
