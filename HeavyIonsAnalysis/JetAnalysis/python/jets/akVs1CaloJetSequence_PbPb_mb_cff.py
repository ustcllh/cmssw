...
akVs1CalomatchGroomed = patJetGenJetMatch.clone(
...
#akVs1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akVs1CalobTagger = bTaggers("akVs1Calo",0.1,False,False)
...
#SUBJETDUMMY_akVs1CaloSubjetImpactParameterTagInfos = akVs1CalobTagger.SubjetImpactParameterTagInfos
#SUBJETDUMMY_akVs1CaloSubjetJetProbabilityBJetTags = akVs1CalobTagger.SubjetJetProbabilityBJetTags
#SUBJETDUMMY_akVs1CaloSubjetSecondaryVertexTagInfos = akVs1CalobTagger.SubjetSecondaryVertexTagInfos
#SUBJETDUMMY_akVs1CaloSubjetSecondaryVertexNegativeTagInfos = akVs1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
#SUBJETDUMMY_akVs1CaloSubjetJetTracksAssociatorAtVertex = akVs1CalobTagger.SubjetJetTracksAssociatorAtVertex
#SUBJETDUMMY_akVs1CaloCombinedSubjetSecondaryVertexBJetTags = akVs1CalobTagger.CombinedSubjetSecondaryVertexBJetTags
#SUBJETDUMMY_akVs1CaloCombinedSubjetSecondaryVertexV2BJetTags = akVs1CalobTagger.CombinedSubjetSecondaryVertexV2BJetTags
#SUBJETDUMMY_akVs1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akVs1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akVs1CaloNjettiness = Njettiness.clone(
		    src = cms.InputTag("akVs1CaloJets"),
           	    R0  = cms.double( 0.1)
)
akVs1CalopatJetsWithBtagging.userData.userFloats.src += ['akVs1CaloNjettiness:tau1','akVs1CaloNjettiness:tau2','akVs1CaloNjettiness:tau3']
...
akVs1CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akVs1CalopatJetsWithBtagging"),
							     ...
							     eventInfoTag = cms.InputTag("generator"),
                                                             ...
                                                             jetName = cms.untracked.string("akVs1Calo"),
							     ...
							     jetFlavourInfos = cms.InputTag("akVs1CaloPatJetFlavourAssociation"),
							     subjetFlavourInfos = cms.InputTag("akVs1CaloPatJetFlavourAssociation","SubJets"),
							     groomedJets = cms.InputTag("akVs1CaloJets"),
...
akVs1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  #akVs1CaloJetID
                                                  #*
                                                  #akVs1CaloPatJetFlavourIdLegacy  # works for PbPb
                                                  #*
			                          #ppDummy_akVs1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akVs1CaloJetSequence = cms.Sequence(akVs1CaloJetSequence_mb)
