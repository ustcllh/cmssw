...
akPuFilter1CaloJetSequence = cms.Sequence(akPuFilter1CaloJetSequence_jec)
akPuFilter1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuFilter1CaloJetAnalyzer.jetPtMin = cms.double(1)
