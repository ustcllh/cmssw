...
akSoftDrop1CalopatJetsWithBtagging.userData.userFloats.src += ['akSoftDrop1CaloJets:sym']
akSoftDrop1CalopatJetsWithBtagging.userData.userInts.src += ['akSoftDrop1CaloJets:droppedBranches']
