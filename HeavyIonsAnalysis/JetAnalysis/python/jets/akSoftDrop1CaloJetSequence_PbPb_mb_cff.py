...
#akSoftDrop1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akSoftDrop1CalobTagger = bTaggers("akSoftDrop1Calo",0.1,False,True)

#create objects locally since they dont load properly otherwise
#akSoftDrop1Calomatch = akSoftDrop1CalobTagger.match
akSoftDrop1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDrop1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDrop1CaloSubjetSecondaryVertexNegativeTagInfos = akSoftDrop1CalobTagger.SubjetSecondaryVertexNegativeTagInfos
...
akSoftDrop1CaloCombinedSubjetNegativeSecondaryVertexV2BJetTags = akSoftDrop1CalobTagger.CombinedSubjetNegativeSecondaryVertexV2BJetTags
...
akSoftDrop1CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
			                          #ppDummy_akSoftDrop1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #ppDummy_*
...
akSoftDrop1CaloJetSequence = cms.Sequence(akSoftDrop1CaloJetSequence_mb)
